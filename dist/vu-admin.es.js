...
var xh = (e, t, s) => t in e ? $h(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s;
var U = (e, t, s) => xh(e, typeof t != "symbol" ? t + "" : t, s);
import { openBlock as g, createElementBlock as b, createElementVNode as f, toDisplayString as L, Fragment as J, renderList as et, normalizeClass as C, createCommentVNode as T, createTextVNode as ct, resolveComponent as pe, withDirectives as at, vModelText as he, withKeys as ai, withModifiers as Lt, createVNode as _r, vModelSelect as ke, createBlock as ze, vModelDynamic as ge, vModelCheckbox as yu, vShow as Ss, normalizeStyle as Qn } from "vue";
...
}, []), Eu = "beforeRead", wu = "read", Tu = "afterRead", Au = "beforeMain", Ou = "main", Nu = "afterMain", ku = "beforeWrite", Cu = "write", Su = "afterWrite", Lu = [Eu, wu, Tu, Au, Ou, Nu, ku, Cu, Su];
function xe(e) {
...
function Rh(e) {
  ...
  return Object.assign(t.elements.popper.style, s.popper), t.styles = s, t.elements.arrow && Object.assign(t.elements.arrow.style, s.arrow), function() {
    Object.keys(t.elements).forEach(function(n) {
      ...
      !se(i) || !xe(i) || (Object.assign(i.style, a), Object.keys(r).forEach(function(l) {
        i.removeAttribute(l);
      }));
    });
  };
...
function Tn(e, t, s) {
  ...
  var o = Ms(e) ? Kt(e) : window, a = o.visualViewport, l = !Iu() && s, u = (n.left + (l && a ? a.offsetLeft : 0)) / i, h = (n.top + (l && a ? a.offsetTop : 0)) / r, d = n.width / i, m = n.height / r;
  return {
    width: d,
    height: m,
    top: h,
...
function wi(e) {
  for (var t = Kt(e), s = $l(e); s && Dh(s) && Ye(s).position === "static"; )
    s = $l(s);
  return s && (xe(s) === "html" || xe(s) === "body" && Ye(s).position === "static") ? t : s || qh(e) || t;
}
function Fa(e) {
...
var Ph = function(t, s) {
  ...
  })) : t, Mu(typeof t != "number" ? t : Ru(t, $n));
};
function Vh(e) {
  var t, s = e.state, n = e.name, i = e.options, r = s.elements.arrow, o = s.modifiersData.popperOffsets, a = Se(s.placement), l = Fa(a), u = [Pt, zt].indexOf(a) >= 0, h = u ? "height" : "width";
  if (!(!r || !o)) {
    var d = Ph(i.padding, s), m = Ua(r), y = l === "y" ? Bt : Pt, E = l === "y" ? Wt : zt, A = s.rects.reference[h] + s.rects.reference[l] - o[l] - s.rects.popper[h], O = o[l] - s.rects.reference[l], N = wi(r), M = N ? l === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, B = A / 2 - O / 2, P = d[y], V = M - m[h] - d[E], X = M / 2 - m[h] / 2 + B, nt = li(P, X, V), lt = l;
...
function xl(e) {
  var t, s = e.popper, n = e.popperRect, i = e.placement, r = e.variation, o = e.offsets, a = e.position, l = e.gpuAcceleration, u = e.adaptive, h = e.roundOffsets, d = e.isFixed, m = o.x, y = m === void 0 ? 0 : m, E = o.y, A = E === void 0 ? 0 : E, O = typeof h == "function" ? h({
    x: y,
    y: A
  }) : {
    x: y,
...
function Yh(e) {
  var t, s = gs(e), n = za(e), i = (t = e.ownerDocument) == null ? void 0 : t.body, r = $s(s.scrollWidth, s.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), o = $s(s.scrollHeight, s.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), a = -n.scrollLeft + Ka(e), l = -n.scrollTop;
  return Ye(i || s).direction === "rtl" && (a += $s(s.clientWidth, i ? i.clientWidth : 0) - r), {
    width: r,
    height: o,
    x: a,
    y: l
...
function Zh(e) {
  ...
  return Ms(n) ? t.filter(function(i) {
    return Ms(i) && $u(i, n) && xe(i) !== "body";
  }) : [];
}
function Qh(e, t, s, n) {
  var i = t === "clippingParents" ? Zh(e) : [].concat(t), r = [].concat(i, [s]), o = r[0], a = r.reduce(function(l, u) {
    var h = Rl(e, u, n);
    return l.top = $s(h.top, l.top), l.right = Er(h.right, l.right), l.bottom = Er(h.bottom, l.bottom), l.left = $s(h.left, l.left), l;
  }, Rl(e, o, n));
  return a.width = a.right - a.left, a.height = a.bottom - a.top, a.x = a.left, a.y = a.top, a;
}
function Bu(e) {
  var t = e.reference, s = e.element, n = e.placement, i = n ? Se(n) : null, r = n ? An(n) : null, o = t.x + t.width / 2 - s.width / 2, a = t.y + t.height / 2 - s.height / 2, l;
  switch (i) {
    case Bt:
      l = {
        x: o,
...
function On(e, t) {
  t === void 0 && (t = {});
  var s = t, n = s.placement, i = n === void 0 ? e.placement : n, r = s.strategy, o = r === void 0 ? e.strategy : r, a = s.boundary, l = a === void 0 ? vu : a, u = s.rootBoundary, h = u === void 0 ? Ba : u, d = s.elementContext, m = d === void 0 ? on : d, y = s.altBoundary, E = y === void 0 ? !1 : y, A = s.padding, O = A === void 0 ? 0 : A, N = Mu(typeof O != "number" ? O : Ru(O, $n)), M = m === on ? _u : on, B = e.rects.popper, P = e.elements[E ? M : m], V = Qh(Ms(P) ? P : P.contextElement || gs(e.elements.popper), l, h, o), X = Tn(e.elements.reference), nt = Bu({
    reference: X,
    element: B,
    strategy: "absolute",
    placement: i
  }), lt = ua(Object.assign({}, B, nt)), vt = m === on ? lt : X, ht = {
...
function ef(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = s.mainAxis, r = i === void 0 ? !0 : i, o = s.altAxis, a = o === void 0 ? !0 : o, l = s.fallbackPlacements, u = s.padding, h = s.boundary, d = s.rootBoundary, m = s.altBoundary, y = s.flipVariations, E = y === void 0 ? !0 : y, A = s.allowedAutoPlacements, O = t.options.placement, N = Se(O), M = N === O, B = l || (M || !E ? [pr(O)] : tf(O)), P = [O].concat(B).reduce(function(it, z) {
      return it.concat(Se(z) === Lr ? Jh(t, {
        placement: z,
        boundary: h,
        rootBoundary: d,
        padding: u,
      ...
      var v = P[ht], $ = Se(v), w = An(v) === xs, q = [Bt, Wt].indexOf($) >= 0, D = q ? "width" : "height", S = On(t, {
        placement: v,
        boundary: h,
        rootBoundary: d,
        altBoundary: m,
      ...
      V[D] > X[D] && (R = pr(R));
      var F = pr(R), W = [];
      if (r && W.push(S[$] <= 0), a && W.push(S[R] <= 0, S[F] <= 0), W.every(function(it) {
        return it;
      })) {
        vt = v, lt = !1;
        break;
...
function lf(e) {
  var t = e.state, s = e.options, n = e.name, i = s.mainAxis, r = i === void 0 ? !0 : i, o = s.altAxis, a = o === void 0 ? !1 : o, l = s.boundary, u = s.rootBoundary, h = s.altBoundary, d = s.padding, m = s.tether, y = m === void 0 ? !0 : m, E = s.tetherOffset, A = E === void 0 ? 0 : E, O = On(t, {
    boundary: l,
    rootBoundary: u,
    padding: d,
    altBoundary: h
  }), N = Se(t.placement), M = An(t.placement), B = !M, P = Fa(N), V = af(P), X = t.modifiersData.popperOffsets, nt = t.rects.reference, lt = t.rects.popper, vt = typeof A == "function" ? A(Object.assign({}, t.rects, {
    placement: t.placement
  ...
  if (X) {
    if (r) {
      var w, q = P === "y" ? Bt : Pt, D = P === "y" ? Wt : zt, S = P === "y" ? "height" : "width", R = X[P], F = R + O[q], W = R - O[D], j = y ? -lt[S] / 2 : 0, st = M === xs ? nt[S] : lt[S], Q = M === xs ? -lt[S] : -nt[S], ot = t.elements.arrow, it = y && ot ? Ua(ot) : {
        width: 0,
        height: 0
      }, z = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : xu(), mt = z[q], Et = z[D], tt = li(0, nt[S], it[S]), ut = B ? nt[S] / 2 - j - tt - mt - ht.mainAxis : st - tt - mt - ht.mainAxis, ft = B ? -nt[S] / 2 + j + tt + Et + ht.mainAxis : Q + tt + Et + ht.mainAxis, dt = t.elements.arrow && wi(t.elements.arrow), bt = dt ? P === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, yt = (w = v == null ? void 0 : v[P]) != null ? w : 0, At = R + ut - yt - bt, kt = R + ft - yt, ss = li(y ? Er(F, At) : F, R, y ? $s(W, kt) : W);
      X[P] = ss, $[P] = ss - R;
    }
    if (a) {
      var _s, Dn = P === "x" ? Bt : Pt, qn = P === "x" ? Wt : zt, Vt = X[V], we = V === "y" ? "height" : "width", Es = Vt + O[Dn], ws = Vt - O[qn], jt = [Bt, Pt].indexOf(N) !== -1, qe = (_s = v == null ? void 0 : v[V]) != null ? _s : 0, Gs = jt ? Es : Vt - nt[we] - lt[we] - qe + ht.altAxis, Te = jt ? Vt + nt[we] + lt[we] - qe - ht.altAxis : ws, Be = y && jt ? Bh(Gs, Vt, Te) : li(y ? Gs : Es, Vt, y ? Te : ws);
      X[V] = Be, $[V] = Be - Vt;
    }
    t.modifiersData[n] = $;
  }
    ...
    var h = {
      ...
      forceUpdate: function() {
        if (!m) {
          ...
          if (Pl(M, B)) {
            h.rects = {
              reference: hf(M, wi(B), h.options.strategy === "fixed"),
              popper: Ua(B)
...
}, Ke = (e) => !e || typeof e != "object" ? !1 : (typeof e.jquery < "u" && (e = e[0]), typeof e.nodeType < "u"), ds = (e) => Ke(e) ? e.jquery ? e[0] : e : typeof e == "string" && e.length > 0 ? document.querySelector(Hu(e)) : null, xn = (e) => {
...
function jl(e, t, s, n, i) {
  ...
  const d = Xu(o, t.replace(kf, "")), m = r ? $f(e, s, o) : If(e, o);
  m.delegationSelector = r ? s : null, m.callable = o, m.oneOff = i, m.uidEvent = d, u[d] = m, e.addEventListener(a, m, r);
}
...
const x = {
  ...
  off(e, t, s, n) {
    ...
    for (const [d, m] of Object.entries(u)) {
      const y = d.replace(Sf, "");
      (!a || t.includes(y)) && ha(e, l, o, m.callable, m.delegationSelector);
    }
  },
  trigger(e, t, s) {
    if (typeof t != "string" || !e)
...
const qo = (e) => {
  ...
  focusableChildren(e) {
    ...
    return this.find(t, e).filter((s) => !hs(s) && xn(s));
  },
...
class Tr extends Ai {
  ...
  _initEvents() {
    this._supportPointerEvents ? (x.on(this._element, Zf, (t) => this._start(t)), x.on(this._element, Qf, (t) => this._end(t)), this._element.classList.add(ep)) : (x.on(this._element, Gf, (t) => this._start(t)), x.on(this._element, Yf, (t) => this._move(t)), x.on(this._element, Xf, (t) => this._end(t)));
  }
...
class Oi extends ye {
  ...
  _addEventListeners() {
    this._config.keyboard && x.on(this._element, dp, (t) => this._keydown(t)), this._config.pause === "hover" && (x.on(this._element, hp, () => this.pause()), x.on(this._element, fp, () => this._maybeEnableCycle())), this._config.touch && Tr.isSupported() && this._addTouchEventListeners();
  }
  ...
  _slide(t, s = null) {
    ...
    if (r === n)
      return;
    const o = this._getItemIndex(r), a = (y) => x.trigger(this._element, y, {
      relatedTarget: r,
...
re(Oi);
const Lp = "collapse", Ip = "bs.collapse", Ni = `.${Ip}`, $p = ".data-api", xp = `show${Ni}`, Mp = `shown${Ni}`, Rp = `hide${Ni}`, Dp = `hidden${Ni}`, qp = `click${Ni}${$p}`, Po = "show", gn = "collapse", Ji = "collapsing", Bp = "collapsed", Pp = `:scope .${gn} .${gn}`, Vp = "collapse-horizontal", jp = "width", Up = "height", Fp = ".collapse.show, .collapse.collapsing", fa = '[data-bs-toggle="collapse"]', Hp = {
  parent: null,
  toggle: !0
}, Wp = {
  parent: "(null|element)",
...
class pi extends ye {
  ...
  show() {
    if (this._isTransitioning || this._isShown())
      return;
    let t = [];
    if (this._config.parent && (t = this._getFirstLevelChildren(Fp).filter((a) => a !== this._element).map((a) => pi.getOrCreateInstance(a, {
      toggle: !1
    ...
    const i = () => {
      this._isTransitioning = !1, this._element.classList.remove(Ji), this._element.classList.add(gn, Po), this._element.style[n] = "", x.trigger(this._element, Mp);
  ...
  hide() {
    ...
    const n = () => {
      this._isTransitioning = !1, this._element.classList.remove(Ji), this._element.classList.add(gn), x.trigger(this._element, Dp);
    };
    ...
    if (!x.trigger(this._element, Qp, t).defaultPrevented) {
      if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(lg))
        for (const n of [].concat(...document.body.children))
          x.on(n, "mouseover", wr);
      this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(ln), this._element.classList.add(ln), x.trigger(this._element, Jp, t);
    }
  }
  hide() {
    if (hs(this._element) || !this._isShown())
...
x.on(document, ad, Ls, Le.dataApiKeydownHandler);
x.on(document, ad, mr, Le.dataApiKeydownHandler);
x.on(document, od, Le.clearMenus);
x.on(document, tg, Le.clearMenus);
x.on(document, od, Ls, function(e) {
...
class cd extends Ai {
  ...
  show(t) {
    ...
    this._config.isAnimated && Ti(s), s.classList.add(Kl), this._emulateAnimation(() => {
      Ht(t);
    });
  }
  hide(t) {
...
const Tg = "focustrap", Ag = "bs.focustrap", Ar = `.${Ag}`, Og = `focusin${Ar}`, Ng = `keydown.tab${Ar}`, kg = "Tab", Cg = "forward", Yl = "backward", Sg = {
  autofocus: !0,
  trapElement: null
...
class ud extends Ai {
  ...
  _handleKeydown(t) {
    t.key === kg && (this._lastTabNavDirection = t.shiftKey ? Yl : Cg);
  }
}
...
const Ig = "modal", $g = "bs.modal", ie = `.${$g}`, xg = ".data-api", Mg = "Escape", Rg = `hide${ie}`, Dg = `hidePrevented${ie}`, dd = `hidden${ie}`, hd = `show${ie}`, qg = `shown${ie}`, Bg = `resize${ie}`, Pg = `click.dismiss${ie}`, Vg = `mousedown.dismiss${ie}`, jg = `keydown.dismiss${ie}`, Ug = `click${ie}${xg}`, Jl = "modal-open", Fg = "fade", tc = "show", Vo = "modal-static", Hg = ".modal.show", Wg = ".modal-dialog", zg = ".modal-body", Kg = '[data-bs-toggle="modal"]', Gg = {
  backdrop: !0,
  focus: !0,
  keyboard: !0
}, Yg = {
...
class Rs extends ye {
  ...
  hide() {
    !this._isShown || this._isTransitioning || x.trigger(this._element, Rg).defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(tc), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()));
  }
  dispose() {
  ...
  _showElement(t) {
    ...
    s && (s.scrollTop = 0), Ti(this._element), this._element.classList.add(tc);
    const n = () => {
  ...
  _hideModal() {
    this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
      document.body.classList.remove(Jl), this._resetAdjustments(), this._scrollBar.reset(), x.trigger(this._element, dd);
    });
  }
  _isAnimated() {
...
class fs extends ye {
  ...
  hide() {
    ...
    const s = () => {
      this._element.classList.remove(ec, nc), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || new pa().reset(), x.trigger(this._element, gd);
    };
...
const _m = "tooltip", Em = /* @__PURE__ */ new Set(["sanitize", "allowList", "sanitizeFn"]), jo = "fade", wm = "modal", er = "show", Tm = ".tooltip-inner", rc = `.${wm}`, oc = "hide.bs.modal", ti = "hover", Uo = "focus", Am = "click", Om = "manual", Nm = "hide", km = "hidden", Cm = "show", Sm = "shown", Lm = "inserted", Im = "click", $m = "focusin", xm = "focusout", Mm = "mouseenter", Rm = "mouseleave", Dm = {
  AUTO: "auto",
  TOP: "top",
  RIGHT: ne() ? "left" : "right",
  BOTTOM: "bottom",
...
let Dr = class bd extends ye {
  ...
  show() {
    ...
    if (!(this._isWithContent() && this._isEnabled))
      return;
    const t = x.trigger(this._element, this.constructor.eventName(Cm)), n = (zu(this._element) || this._element.ownerDocument.documentElement).contains(this._element);
    ...
    if (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(i), x.trigger(this._element, this.constructor.eventName(Lm))), this._popper = this._createPopper(i), i.classList.add(er), "ontouchstart" in document.documentElement)
      for (const a of [].concat(...document.body.children))
        x.on(a, "mouseover", wr);
    const o = () => {
      x.trigger(this._element, this.constructor.eventName(Sm)), this._isHovered === !1 && this._leave(), this._isHovered = !1;
    };
  ...
  hide() {
    ...
    this._activeTrigger[Am] = !1, this._activeTrigger[Uo] = !1, this._activeTrigger[ti] = !1, this._isHovered = null;
    const n = () => {
  ...
  _setListeners() {
    ...
    for (const s of t)
      if (s === "click")
        ...
        const n = s === ti ? this.constructor.eventName(Mm) : this.constructor.eventName($m), i = s === ti ? this.constructor.eventName(Rm) : this.constructor.eventName(xm);
...
class Nn extends ye {
  constructor(t) {
    super(t), this._parent = this._element.closest(yb), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), x.on(this._element, hb, (s) => this._keydown(s)));
  }
  // Getters
  static get NAME() {
    return rb;
...
x.on(document, db, vd, function(e) {
...
re(Nn);
const wb = "toast", Tb = "bs.toast", bs = `.${Tb}`, Ab = `mouseover${bs}`, Ob = `mouseout${bs}`, Nb = `focusin${bs}`, kb = `focusout${bs}`, Cb = `hide${bs}`, Sb = `hidden${bs}`, Lb = `show${bs}`, Ib = `shown${bs}`, $b = "fade", fc = "hide", sr = "show", nr = "showing", xb = {
  animation: "boolean",
  autohide: "boolean",
  delay: "number"
}, Mb = {
...
class Br extends ye {
  ...
  show() {
    ...
    this._element.classList.remove(fc), Ti(this._element), this._element.classList.add(sr, nr), this._queueCallback(s, this._element, this._config.animation);
  }
  hide() {
    if (!this.isShown() || x.trigger(this._element, Cb).defaultPrevented)
      return;
    const s = () => {
      this._element.classList.add(fc), this._element.classList.remove(nr, sr), x.trigger(this._element, Sb);
    };
...
var _d = typeof global == "object" && global && global.Object === Object && global, Fb = typeof self == "object" && self && self.Object === Object && self, De = _d || Fb || Function("return this")(), ps = De.Symbol, Ed = Object.prototype, Hb = Ed.hasOwnProperty, Wb = Ed.toString, si = ps ? ps.toStringTag : void 0;
function zb(e) {
...
function Od(e, t, s) {
  var n = e[t];
  (!(k1.call(e, t) && Ci(n, s)) || s === void 0 && !(t in e)) && ul(e, t, s);
}
function Si(e, t, s, n) {
  var i = !s;
  s || (s = {});
...
function I1(e, t, s) {
  if (!ys(s))
    return !1;
  var n = typeof t;
  return (n == "number" ? Vr(s) && Ad(t, s.length) : n == "string" && t in s) ? Ci(s[t], e) : !1;
}
function $1(e) {
  return S1(function(t, s) {
...
function dy(e) {
  return Xe(e) && Nd(e.length) && !!Tt[Rn(e)];
}
function hl(e) {
  return function(t) {
    return e(t);
...
var Sd = typeof exports == "object" && exports && !exports.nodeType && exports, ui = Sd && typeof module == "object" && module && !module.nodeType && module, hy = ui && ui.exports === Sd, Yo = hy && _d.process, kn = function() {
  try {
...
function Ld(e, t) {
  var s = Ds(e), n = !s && ma(e), i = !s && !n && gi(e), r = !s && !n && !i && fl(e), o = s || n || i || r, a = o ? M1(e.length, String) : [], l = a.length;
  for (var u in e)
...
function xy(e, t) {
  var s = this.__data__;
  return this.size += this.has(e) ? 0 : 1, s[e] = mi && t === void 0 ? $y : t, this;
}
function qs(e) {
...
var gl = Id(Object.getPrototypeOf, Object), Ky = "[object Object]", Gy = Function.prototype, Yy = Object.prototype, xd = Gy.toString, Xy = Yy.hasOwnProperty, Zy = xd.call(Object);
function Qy(e) {
  if (!Xe(e) || Rn(e) != Ky)
    return !1;
  var t = gl(e);
  ...
  return typeof s == "function" && s instanceof s && xd.call(s) == Zy;
}
function Jy() {
...
var ya = Fs(De, "DataView"), va = Fs(De, "Promise"), _a = Fs(De, "Set"), Nc = "[object Map]", gv = "[object Object]", kc = "[object Promise]", Cc = "[object Set]", Sc = "[object WeakMap]", Lc = "[object DataView]", mv = Us(ya), bv = Us(bi), yv = Us(va), vv = Us(_a), _v = Us(ga), de = Rn;
(ya && de(new ya(new ArrayBuffer(1))) != Lc || bi && de(new bi()) != Nc || va && de(va.resolve()) != kc || _a && de(new _a()) != Cc || ga && de(new ga()) != Sc) && (de = function(e) {
  var t = Rn(e), s = t == gv ? e.constructor : void 0, n = s ? Us(s) : "";
  if (n)
    switch (n) {
      case mv:
        return Lc;
...
var xc = kn && kn.isMap, Xv = xc ? hl(xc) : Yv, Zv = "[object Set]";
function Qv(e) {
  return Xe(e) && de(e) == Zv;
}
...
Cr.prototype.add = Cr.prototype.push = S0;
Cr.prototype.has = L0;
function I0(e, t) {
...
function Hd(e, t, s, n, i, r) {
  var o = s & x0, a = e.length, l = t.length;
  if (a != l && !(o && l > a))
    return !1;
  var u = r.get(e), h = r.get(t);
  if (u && h)
    return u == t && h == e;
  var d = -1, m = !0, y = s & M0 ? new Cr() : void 0;
...
function t_(e, t, s, n, i, r) {
  ...
  for (var O = o; ++d < l; ) {
    ...
    var N = e[m], M = t[m];
    if (n)
      var B = o ? n(M, N, m, t, e, r) : n(N, M, m, e, t, r);
...
var r_ = i_();
function Ea(e, t, s) {
  (s !== void 0 && !Ci(e[t], s) || s === void 0 && !(t in e)) && ul(e, t, s);
}
function o_(e) {
  return Xe(e) && Vr(e);
}
...
function l_(e, t, s, n, i, r, o) {
  ...
  if (d) {
    var m = Ds(l), y = !m && gi(l), E = !m && !y && fl(l);
    h = l, m || y || E ? Ds(a) ? h = a : o_(a) ? h = Td(a) : y ? (d = !1, h = Rd(l, !0)) : E ? (d = !1, h = Pd(l, !0)) : h = [] : Qy(l) || ma(l) ? (h = a, ma(a) ? h = a_(a) : (!ys(a) || cl(a)) && (h = Vd(l))) : d = !1;
  }
...
hn.blotName = "scroll", hn.defaultChild = yi, hn.allowedChildren = [yi, Hr], hn.scope = G.BLOCK_BLOT, hn.tagName = "DIV";
let w_ = hn;
...
let T_ = Na;
const Sr = T_, A_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Attributor: Me,
  AttributorStore: Fr,
  BlockBlot: yi,
...
function O_() {
  ...
  function n(v, $, w, q, D) {
    ...
    var R = a(v, $), F = v.substring(0, R);
    v = v.substring(R), $ = $.substring(R), R = u(v, $);
    var W = v.substring(v.length - R);
    v = v.substring(0, v.length - R), $ = $.substring(0, $.length - R);
    var j = i(v, $);
  ...
  function i(v, $) {
    ...
    if (!$)
      return [[e, v]];
    var q = v.length > $.length ? v : $, D = v.length > $.length ? $ : v, S = q.indexOf(D);
    if (S !== -1)
      return w = [
        [t, q.substring(0, S)],
        [s, D],
  ...
  function r(v, $) {
    for (var w = v.length, q = $.length, D = Math.ceil((w + q) / 2), S = D, R = 2 * D, F = new Array(R), W = new Array(R), j = 0; j < R; j++)
      F[j] = -1, W[j] = -1;
    F[S + 1] = 0, W[S + 1] = 0;
    for (var st = w - q, Q = st % 2 !== 0, ot = 0, it = 0, z = 0, mt = 0, Et = 0; Et < D; Et++) {
      for (var tt = -Et + ot; tt <= Et - it; tt += 2) {
        ...
        for (var dt = ft - tt; ft < w && dt < q && v.charAt(ft) === $.charAt(dt); )
          ft++, dt++;
        if (F[ut] = ft, ft > w)
          it += 2;
        else if (dt > q)
  ...
  function o(v, $, w, q) {
    var D = v.substring(0, w), S = $.substring(0, q), R = v.substring(w), F = $.substring(q), W = n(D, S), j = n(R, F);
    return W.concat(j);
  }
  function a(v, $) {
    if (!v || !$ || v.charAt(0) !== $.charAt(0))
      return 0;
    for (var w = 0, q = Math.min(v.length, $.length), D = q, S = 0; w < D; )
      v.substring(S, D) == $.substring(S, D) ? (w = D, S = w) : q = D, D = Math.floor((q - w) / 2 + w);
  ...
  function l(v, $) {
    ...
    if (v == $)
      return D;
    for (var S = 0, R = 1; ; ) {
      var F = v.substring(D - R), W = $.indexOf(F);
      if (W == -1)
        return S;
      R += W, (W == 0 || v.substring(D - R) == $.substring(0, R)) && (S = R, R++);
    }
  }
  function u(v, $) {
    if (!v || !$ || v.slice(-1) !== $.slice(-1))
      return 0;
    for (var w = 0, q = Math.min(v.length, $.length), D = q, S = 0; w < D; )
      v.substring(v.length - D, v.length - S) == $.substring($.length - D, $.length - S) ? (w = D, S = w) : q = D, D = Math.floor((q - w) / 2 + w);
  ...
  function d(v) {
    for (var $ = !1, w = [], q = 0, D = null, S = 0, R = 0, F = 0, W = 0, j = 0; S < v.length; )
      v[S][0] == s ? (w[q++] = S, R = W, F = j, W = 0, j = 0, D = v[S][1]) : (v[S][0] == t ? W += v[S][1].length : j += v[S][1].length, D && D.length <= Math.max(R, F) && D.length <= Math.max(W, j) && (v.splice(w[q - 1], 0, [
        e,
        D
      ]), v[w[q - 1] + 1][0] = t, q--, q--, S = q > 0 ? w[q - 1] : -1, R = 0, F = 0, W = 0, j = 0, D = null, $ = !0)), S++;
    for ($ && M(v), N(v), S = 1; S < v.length; ) {
      if (v[S - 1][0] == e && v[S][0] == t) {
        var st = v[S - 1][1], Q = v[S][1], ot = l(st, Q), it = l(Q, st);
        ot >= it ? (ot >= st.length / 2 || ot >= Q.length / 2) && (v.splice(S, 0, [
          s,
          Q.substring(0, ot)
        ]), v[S - 1][1] = st.substring(
          0,
          st.length - ot
        ), v[S + 1][1] = Q.substring(ot), S++) : (it >= st.length / 2 || it >= Q.length / 2) && (v.splice(S, 0, [
          s,
          st.substring(0, it)
        ]), v[S - 1][0] = t, v[S - 1][1] = Q.substring(
          0,
          Q.length - it
        ), v[S + 1][0] = e, v[S + 1][1] = st.substring(it), S++), S++;
      }
      S++;
    }
  }
  ...
  function N(v) {
    function $(it, z) {
      if (!it || !z)
        return 6;
      var mt = it.charAt(it.length - 1), Et = z.charAt(0), tt = mt.match(m), ut = Et.match(m), ft = tt && mt.match(y), dt = ut && Et.match(y), bt = ft && mt.match(E), yt = dt && Et.match(E), At = bt && it.match(A), kt = yt && z.match(O);
    ...
    for (var w = 1; w < v.length - 1; ) {
      if (v[w - 1][0] == s && v[w + 1][0] == s) {
        ...
        for (var W = q, j = D, st = S, Q = $(q, D) + $(D, S); D.charAt(0) === S.charAt(0); ) {
          q += D.charAt(0), D = D.substring(1) + S.charAt(0), S = S.substring(1);
          var ot = $(q, D) + $(D, S);
          ot >= Q && (Q = ot, W = q, j = D, st = S);
        }
      ...
      switch (v[w][0]) {
        ...
        case s:
          ...
          if ($) {
            if (W >= 0 && X(v[W][1])) {
              ...
              if (v[W][1] = v[W][1].slice(
                ...
                v.splice(W, 1), w--;
                var st = W - 1;
                v[st] && v[st][0] === t && (D++, R = v[st][1] + R, st--), v[st] && v[st][0] === e && (q++, S = v[st][1] + S, st--), W = st;
              }
            }
            if (V(v[w][1])) {
          ...
          if (S.length > 0 || R.length > 0) {
            S.length > 0 && R.length > 0 && (F = a(R, S), F !== 0 && (W >= 0 ? v[W][1] += R.substring(
              0,
              F
            ) : (v.splice(0, 0, [
              s,
  ...
  function vt(v, $, w) {
    var q = typeof w == "number" ? { index: w, length: 0 } : w.oldRange, D = typeof w == "number" ? null : w.newRange, S = v.length, R = $.length;
    if (q.length === 0 && (D === null || D.length === 0)) {
      ...
      t: {
        ...
        if (ot !== W)
          break t;
        var dt = Math.min(S - ft, R - ft), bt = j.slice(j.length - dt), yt = it.slice(it.length - dt);
        if (bt !== yt)
          break t;
    ...
    if (q.length > 0 && D && D.length === 0)
      t: {
        ...
        if (R < z + dt)
          break t;
        var Et = $.slice(0, z), yt = $.slice(R - dt);
        if (mt !== Et || bt !== yt)
          break t;
        var tt = v.slice(z, S - dt), ut = $.slice(z, R - dt);
...
function th() {
  return Uc || (Uc = 1, function(e, t) {
    var s = 200, n = "__lodash_hash_undefined__", i = 9007199254740991, r = "[object Arguments]", o = "[object Array]", a = "[object Boolean]", l = "[object Date]", u = "[object Error]", h = "[object Function]", d = "[object GeneratorFunction]", m = "[object Map]", y = "[object Number]", E = "[object Object]", A = "[object Promise]", O = "[object RegExp]", N = "[object Set]", M = "[object String]", B = "[object Symbol]", P = "[object WeakMap]", V = "[object ArrayBuffer]", X = "[object DataView]", nt = "[object Float32Array]", lt = "[object Float64Array]", vt = "[object Int8Array]", ht = "[object Int16Array]", v = "[object Int32Array]", $ = "[object Uint8Array]", w = "[object Uint8ClampedArray]", q = "[object Uint16Array]", D = "[object Uint32Array]", S = /[\\^$.*+?()[\]{}|]/g, R = /\w*$/, F = /^\[object .+?Constructor\]$/, W = /^(?:0|[1-9]\d*)$/, j = {};
    j[r] = j[o] = j[V] = j[X] = j[a] = j[l] = j[nt] = j[lt] = j[vt] = j[ht] = j[v] = j[m] = j[y] = j[E] = j[O] = j[N] = j[M] = j[B] = j[$] = j[w] = j[q] = j[D] = !0, j[u] = j[h] = j[P] = !1;
    ...
    $t.prototype.clear = no, $t.prototype.delete = io, $t.prototype.get = ro, $t.prototype.has = oo, $t.prototype.set = ao;
    function Ut(c) {
    ...
    function zn(c, p, _, k, rt, Y, gt) {
      ...
      return ut(Nt || c, function(Mt, St) {
        Nt && (St = Mt, Mt = c[St]), Vi(pt, St, zn(Mt, p, _, k, St, c, gt));
      }), pt;
    }
    function po(c) {
      return Ne(c) ? Ri(c) : {};
    ...
    (Xs && je(new Xs(new ArrayBuffer(1))) != X || Ts && je(new Ts()) != m || ae && je(ae.resolve()) != A || Zs && je(new Zs()) != N || Vn && je(new Vn()) != P) && (je = function(c) {
...
function eh() {
  return Fc || (Fc = 1, function(e, t) {
    var s = 200, n = "__lodash_hash_undefined__", i = 1, r = 2, o = 9007199254740991, a = "[object Arguments]", l = "[object Array]", u = "[object AsyncFunction]", h = "[object Boolean]", d = "[object Date]", m = "[object Error]", y = "[object Function]", E = "[object GeneratorFunction]", A = "[object Map]", O = "[object Number]", N = "[object Null]", M = "[object Object]", B = "[object Promise]", P = "[object Proxy]", V = "[object RegExp]", X = "[object Set]", nt = "[object String]", lt = "[object Symbol]", vt = "[object Undefined]", ht = "[object WeakMap]", v = "[object ArrayBuffer]", $ = "[object DataView]", w = "[object Float32Array]", q = "[object Float64Array]", D = "[object Int8Array]", S = "[object Int16Array]", R = "[object Int32Array]", F = "[object Uint8Array]", W = "[object Uint8ClampedArray]", j = "[object Uint16Array]", st = "[object Uint32Array]", Q = /[\\^$.*+?()[\]{}|]/g, ot = /^\[object .+?Constructor\]$/, it = /^(?:0|[1-9]\d*)$/, z = {};
    z[w] = z[q] = z[D] = z[S] = z[R] = z[F] = z[W] = z[j] = z[st] = !0, z[a] = z[l] = z[v] = z[h] = z[$] = z[d] = z[m] = z[y] = z[A] = z[O] = z[M] = z[V] = z[X] = z[nt] = z[ht] = !1;
    ...
    var qe = Array.prototype, Gs = Function.prototype, Te = Object.prototype, Be = tt["__core-js_shared__"], Bn = Gs.toString, Yt = Te.hasOwnProperty, Ri = function() {
    ...
    ), Pn = dt ? tt.Buffer : void 0, Ys = tt.Symbol, qi = tt.Uint8Array, Xs = Te.propertyIsEnumerable, Ts = qe.splice, ae = Ys ? Ys.toStringTag : void 0, Zs = Object.getOwnPropertySymbols, Vn = Pn ? Pn.isBuffer : void 0, As = ws(Object.keys, Object), jn = Ve(tt, "DataView"), Os = Ve(tt, "Map"), Un = Ve(tt, "Promise"), Fn = Ve(tt, "Set"), Hn = Ve(tt, "WeakMap"), ns = Ve(Object, "create"), Bi = qt(jn), Pe = qt(Os), Yr = qt(Un), Xr = qt(Fn), Zr = qt(Hn), Pi = Ys ? Ys.prototype : void 0, Wn = Pi ? Pi.valueOf : void 0;
    function Ct(c) {
    ...
    function yo(c, p) {
      var _ = en(c), k = !_ && Wi(c), rt = !_ && !k && sn(c), Y = !_ && !k && !rt && Gi(c), gt = _ || k || rt || Y, pt = gt ? Dn(c.length, String) : [], Ot = pt.length;
      for (var _t in c)
    ...
    function vo(c, p, _, k, rt, Y) {
      ...
      if (!(_ & i)) {
        var Mt = xt && Yt.call(c, "__wrapped__"), St = Ft && Yt.call(p, "__wrapped__");
        if (Mt || St) {
          var is = Mt ? c.value() : c, Ue = St ? p.value() : p;
    ...
    function Gn(c, p, _, k, rt, Y) {
      ...
      for (Y.set(c, p), Y.set(p, c); ++xt < pt; ) {
        var Mt = c[xt], St = p[xt];
        if (k)
          var is = gt ? k(St, Mt, xt, p, c, Y) : k(Mt, St, xt, c, p, Y);
        if (is !== void 0) {
          if (is)
            continue;
          Ft = !1;
    ...
    function Ao(c, p, _, k, rt, Y) {
      ...
      for (var is = gt; ++Ft < Ot; ) {
        ...
        var Ue = c[Nt], Cs = p[Nt];
        if (k)
          var Il = gt ? k(Cs, Ue, Nt, p, c, Y) : k(Ue, Cs, Nt, c, p, Y);
        if (!(Il === void 0 ? Ue === Cs || rt(Ue, Cs, _, k, Y) : Il)) {
          St = !1;
          break;
        }
    ...
    (jn && Oe(new jn(new ArrayBuffer(1))) != $ || Os && Oe(new Os()) != A || Un && Oe(Un.resolve()) != B || Fn && Oe(new Fn()) != X || Hn && Oe(new Hn()) != ht) && (Oe = function(c) {
...
function N_() {
  ...
  return function(n) {
    function i(l = {}, u = {}, h = !1) {
      ...
      let d = e(u);
      h || (d = Object.keys(d).reduce((m, y) => (d[y] != null && (m[y] = d[y]), m), {}));
      for (const m in l)
        l[m] !== void 0 && u[m] === void 0 && (d[m] = l[m]);
      return Object.keys(d).length > 0 ? d : void 0;
    }
    n.compose = i;
    function r(l = {}, u = {}) {
      typeof l != "object" && (l = {}), typeof u != "object" && (u = {});
      const h = Object.keys(l).concat(Object.keys(u)).reduce((d, m) => (t(l[m], u[m]) || (d[m] = u[m] === void 0 ? null : u[m]), d), {});
      return Object.keys(h).length > 0 ? h : void 0;
    }
    n.diff = r;
    function o(l = {}, u = {}) {
      l = l || {};
      const h = Object.keys(u).reduce((d, m) => (u[m] !== l[m] && l[m] !== void 0 && (d[m] = u[m]), d), {});
      return Object.keys(l).reduce((d, m) => (l[m] !== u[m] && u[m] === void 0 && (d[m] = null), d), h);
    }
    n.invert = o;
    function a(l, u, h = !1) {
      if (typeof l != "object")
      ...
      if (!h)
        return u;
      const d = Object.keys(u).reduce((m, y) => (l[y] === void 0 && (m[y] = u[y]), m), {});
      return Object.keys(d).length > 0 ? d : void 0;
    }
    n.transform = a;
  }(s || (s = {})), or.default = s, or;
...
function C_() {
  return Kc || (Kc = 1, function(e, t) {
    ...
    class h {
      ...
      changeLength() {
        return this.reduce((m, y) => y.insert ? m + o.default.length(y) : y.delete ? m - y.delete : m, 0);
      }
      length() {
        return this.reduce((m, y) => m + o.default.length(y), 0);
      }
      slice(m = 0, y = 1 / 0) {
        ...
        for (; O < y && A.hasNext(); ) {
          let N;
          O < m ? N = A.next(m - O) : (N = A.next(y - O), E.push(N)), O += o.default.length(N);
        }
        return new h(E);
      }
      compose(m) {
        const y = new a.default(this.ops), E = new a.default(m.ops), A = [], O = E.peek();
      ...
      diff(m, y) {
        ...
        }).join("")), A = new h(), O = s(E[0], E[1], y, !0), N = new a.default(this.ops), M = new a.default(m.ops);
        return O.forEach((B) => {
          let P = B[1].length;
          for (; P > 0; ) {
            let V = 0;
...
`) {
        ...
        return this.reduce((E, A) => {
          if (A.insert)
            ...
            if (A.delete || typeof A.retain == "number") {
              ...
              return m.slice(E, E + O).forEach((M) => {
              ...
              const O = m.slice(E, E + 1), N = new a.default(O.ops).next(), [M, B, P] = u(A.retain, N.insert), V = h.getHandler(M);
      ...
      transform(m, y = !1) {
        ...
        const E = m, A = new a.default(this.ops), O = new a.default(E.ops), N = new h();
...
function Wr(e) {
  return e.replace(/[&<>"']/g, (t) => S_[t]);
}
const Ce = class Ce extends vl {
  static compare(t, s) {
    const n = Ce.order.indexOf(t), i = Ce.order.indexOf(s);
    return n >= 0 || i >= 0 ? n - i : t === s ? 0 : t < s ? -1 : 1;
  }
  formatAt(t, s, n, i) {
    if (Ce.compare(this.statics.blotName, n) < 0 && this.scroll.query(n, G.BLOT)) {
      const r = this.isolate(t, s);
      i && r.wrap(n, i);
    } else
  ...
  optimize(t) {
    if (super.optimize(t), this.parent instanceof Ce && Ce.compare(this.statics.blotName, this.parent.statics.blotName) > 0) {
      const s = this.parent.isolate(this.offset(), this.length());
      this.moveChildren(s), s.wrap(this);
    }
  }
};
U(Ce, "allowedChildren", [Ce, _e, Gt, be]), // Lower index means deeper in the DOM tree, since not found (-1) is for embeds
U(Ce, "order", [
  "cursor",
  "inline",
  // Must be lower
...
const Zt = class Zt extends Gt {
  ...
  restore() {
    ...
    if (this.remove(), t) {
      const u = (m, y) => s && m === s.domNode ? y : m === o ? n + y - 1 : i && m === i.domNode ? n + a.length + y : null, h = u(t.start.node, t.start.offset), d = u(t.end.node, t.end.offset);
      if (h !== null && d !== null)
        return {
          startNode: l.domNode,
          startOffset: h,
...
function L_() {
  return Yc || (Yc = 1, function(e) {
    ...
    function r(l, u, h, d, m) {
      if (typeof h != "function")
        throw new TypeError("The listener must be a function");
      var y = new i(h, d || l, m), E = s ? s + u : u;
    ...
    a.prototype.eventNames = function() {
    ...
    }, a.prototype.emit = function(u, h, d, m, y, E) {
      var A = s ? s + u : u;
      ...
      if (O.fn) {
        switch (O.once && this.removeListener(u, O.fn, void 0, !0), N) {
          ...
          case 4:
            return O.fn.call(O.context, h, d, m), !0;
          case 5:
            return O.fn.call(O.context, h, d, m, y), !0;
          case 6:
            return O.fn.call(O.context, h, d, m, y, E), !0;
        }
    ...
    }, a.prototype.removeListener = function(u, h, d, m) {
      var y = s ? s + u : u;
      ...
      if (E.fn)
        E.fn === h && (!m || E.once) && (!d || E.context === d) && o(this, y);
      else {
        for (var A = 0, O = [], N = E.length; A < N; A++)
          (E[A].fn !== h || m && !E[A].once || d && E[A].context !== d) && O.push(E[A]);
...
var I_ = L_();
const $_ = /* @__PURE__ */ Jd(I_), ka = /* @__PURE__ */ new WeakMap(), Ca = ["error", "warn", "log", "info"];
let Sa = "warn";
function ih(e) {
...
function es(e) {
  return Ca.reduce((t, s) => (t[s] = ih.bind(console, s, e), t), {});
}
es.level = (e) => {
  Sa = e;
};
...
class M_ {
  ...
  getBounds(t) {
    ...
    if (s > 0 && o === r.length()) {
      ...
      if (h) {
        const [d] = this.scroll.line(t), [m] = this.scroll.line(t + 1);
        d === m && (r = h, o = 0);
      }
    }
    [i, o] = r.position(o, !0);
...
` && (h = !0) : O instanceof Gt && O.statics.scope === G.INLINE_BLOT && (h = !0);
      ...
      const m = h ? 1 : 0, y = d ? 1 : 0;
      return s += m + y, i.retain(m), i.delete(y), o + l + m + y;
...
`));
  ...
  update(t) {
    ...
    s[0].target.data.match(R_) && this.scroll.find(s[0].target)) {
      const r = this.scroll.find(s[0].target), o = Qt(r), a = r.offset(this.scroll), l = s[0].oldValue.replace(Sn.CONTENTS, ""), u = new K().insert(l), h = new K().insert(r.value()), d = n && {
...
function fn(e, t, s) {
  ...
  if (o > t)
    return s.push(a), o === t + 1 ? `<${u}><li${h}>${vi(n, i, r)}${fn(l, o, s)}` : `<${u}><li>${fn(e, t + 1, s)}`;
  const d = s[s.length - 1];
  if (o === t && a === d)
    return `</li><li${h}>${vi(n, i, r)}${fn(l, o, s)}`;
  const [m] = na(s.pop());
...
function vi(e, t, s) {
  ...
  if (e instanceof me) {
    if (e.statics.blotName === "list-container") {
      const u = [];
      return e.children.forEachAt(t, s, (h, d, m) => {
...
const V_ = (e) => e.parentElement || e.getRootNode().host || null, j_ = (e) => {
  ...
  for (; i; ) {
    const l = i === s.body, u = l ? {
      ...
      left: 0
    } : j_(i), h = getComputedStyle(i), d = Qc(n.left, n.right, u.left, u.right, ur(h.scrollPaddingLeft), ur(h.scrollPaddingRight)), m = Qc(n.top, n.bottom, u.top, u.bottom, ur(h.scrollPaddingTop), ur(h.scrollPaddingBottom));
    if (d || m)
      if (l)
        (a = s.defaultView) == null || a.scrollBy(d, m);
      else {
        const {
          scrollLeft: y,
          scrollTop: E
        } = i;
        m && (i.scrollTop += m), d && (i.scrollLeft += d);
...
function z_(e, t) {
  ...
  let m = t.registry;
  return m ? t.formats && _n.warn('Ignoring "formats" option because "registry" is specified') : m = t.formats ? W_(t.formats, d.registry, _n) : d.registry, {
    ...d,
    registry: m,
    container: s,
    theme: i,
...
`))), i = n.pop();
    ...
    if (r) {
      ...
      l && this.insertAt(d - 1, `
`);
      const m = Qt(this.line(t)[0]), y = ee.AttributeMap.diff(m, r.attributes) || {};
...
U(pn, "blotName", "scroll"), U(pn, "className", "ql-editor"), U(pn, "tagName", "DIV"), U(pn, "defaultChild", It), U(pn, "allowedChildren", [It, te, Ws]);
function ra(e, t, s) {
  s.reduce((n, i) => {
...
class zr extends Ee {
  ...
  listen() {
    this.quill.root.addEventListener("keydown", (t) => {
      ...
      const [a, l] = this.quill.getLine(o.index), [u, h] = this.quill.getLeaf(o.index), [d, m] = o.length === 0 ? [u, h] : this.quill.getLeaf(o.index + o.length), y = u instanceof Sr ? u.value().slice(0, h) : "", E = d instanceof Sr ? d.value().slice(m) : "", A = {
...
const aE = /\bmso-list:[^;]*ignore/i, lE = /\bmso-list:[^;]*\bl(\d+)/i, cE = /\bmso-list:[^;]*\blevel(\d+)/i, uE = (e, t) => {
  ...
  for (; r.length; ) {
    ...
    d && (m == null || m.replaceChild(h, d)), l.slice(1).forEach((y) => {
      let {
        element: E
      } = y;
...
}, gE = es("quill:clipboard"), mE = [[Node.TEXT_NODE, CE], [Node.TEXT_NODE, lu], ["br", EE], [Node.ELEMENT_NODE, lu], [Node.ELEMENT_NODE, _E], [Node.ELEMENT_NODE, vE], [Node.ELEMENT_NODE, NE], ["li", AE], ["ol, ul", OE], ["pre", wE], ["tr", kE], ["b", aa("bold")], ["i", aa("italic")], ["strike", aa("strike")], ["style", TE]], bE = [K_, lh].reduce((e, t) => (e[t.keyName] = t, e), {}), au = [oh, Al, Tl, uh, fh, gh].reduce((e, t) => (e[t.keyName] = t, e), {});
class mh extends Ee {
  constructor(t, s) {
    ...
    if (s || this.forceNext || this.cachedText !== i) {
      if (i.trim().length > 0 || this.cachedText == null) {
        ...
        o.diff(a).reduce((l, u) => {
          ...
          return h ? (d && Object.keys(d).forEach((m) => {
            [Jt.blotName, Ze.blotName].includes(m) && this.formatAt(l, h, m, d[m]);
          }), l + h) : l;
        }, 0);
      }
...
Jt.allowedChildren = [Ze, Sn, be, _e];
const VE = (e, t, s) => {
...
class Eh extends Ee {
  static register() {
    I.register(Ze, !0), I.register(Jt, !0), I.register(di, !0);
  }
  constructor(t, s) {
...
`, {
    ...
    return n.classList.add(Dt.className), n.innerHTML = VE(this.options.hljs, s, t), Cl(this.quill.scroll, n, [(i, r) => {
      const o = oi.value(i);
...
class In extends Ws {
  ...
  insertRow(t) {
    ...
    const n = Sl(), i = this.scroll.create(Qe.blotName);
...
$e.allowedChildren = [Qe];
Qe.requiredContainer = $e;
...
class jE extends Ee {
  static register() {
    I.register(fe), I.register(Qe), I.register($e), I.register(In);
  }
  constructor() {
  ...
  buildPickers(t, s) {
    this.pickers = Array.from(t).map((i) => {
      ...
      if (i.classList.contains("ql-background") || i.classList.contains("ql-color")) {
        ...
        return i.querySelector("option") == null && ni(i, Ow, r === "background" ? "#ffffff" : "#000000"), new wh(i, s[r]);
      }
      return i.querySelector("option") == null && (i.classList.contains("ql-font") ? ni(i, Nw) : i.classList.contains("ql-header") ? ni(i, kw) : i.classList.contains("ql-size") && ni(i, Cw)), new Kr(i);
    });
    const n = () => {
...
}, xw = $w, Mw = { class: "ql-editor-container" }, Rw = {
  class: "",
  ref: "editor"
};
...
function rT(e, t, s, n, i, r) {
  return g(), b("div", null, [
    e.file ? (g(), b("table", Vw, [
      ...
      f("tbody", null, [
        f("tr", null, [
          ...
          f("td", jw, L(e.file.original.width) + " x " + L(e.file.original.height), 1),
          f("td", Uw, L(e.file.original.ratio), 1),
          f("td", Fw, [
            f("span", {
              innerHTML: e.roundFileSize(e.file.original.bytes, !0)
            }, null, 8, Hw)
          ]),
          f("td", Ww, L(e.file.original.extension), 1),
          t[1] || (t[1] = f("td", null, null, -1))
        ]),
        (g(!0), b(J, null, et(e.file.types, (o, a) => (g(), b("tr", { key: o }, [
          f("td", null, L(a), 1),
          f("td", zw, L(o.width) + " x " + L(o.height), 1),
          f("td", Kw, L(o.ratio), 1),
          f("td", Gw, [
            f("span", {
          ...
          f("td", Xw, L(o.extension), 1),
          f("td", null, [
            o.crop ? (g(), b("small", Zw, L(o.crop), 1)) : T("", !0)
          ])
        ]))), 128))
      ]),
      f("tfoot", null, [
        f("tr", null, [
          f("td", Qw, L(e.file.uploaded ? "uploaded" : "uploading"), 1),
          f("td", Jw, [
            f("span", {
              class: "text-nowrap",
    ...
    f("small", eT, [
      ...
      ct(" " + L(e.file.original.name), 1)
    ]),
    f("small", sT, [
      f("span", nT, L(e.file.uploaded ? "uploaded" : "uploading") + " filename", 1),
      t[5] || (t[5] = ct()),
      f("span", null, L(e.file.slug), 1)
    ]),
    e.file.uploaded ? (g(), b("small", iT, [
      t[6] || (t[6] = f("span", { class: "text-muted fw-light me-3" }, "uploaded at", -1)),
      t[7] || (t[7] = ct()),
      f("span", null, L(e.dateFormat(e.file.timestamp * 1e3)), 1)
    ])) : T("", !0)
  ]);
}
const oT = /* @__PURE__ */ oe(Pw, [["render", rT]]), Xt = {
  ...
  methods: {
    ...
    async forEachPresets(e, t, s) {
      ...
      for (let l in this.params.presets) {
        ...
        if (u.crop === "cover") {
          let m = Math.max(h / o, d / a), y = o * m, E = a * m, A = (y - h) / 2, O = (E - d) / 2;
          n.width = h, n.height = d, i.drawImage(t, -A, -O, y, E);
        } else if (u.crop === "contain") {
          let m = Math.min(h / o, d / a), y = o * m, E = a * m, A = (h - y) / 2, O = (d - E) / 2;
  ...
  key: 1,
  class: "row g-2 mb-1"
}, wT = { key: 0 }, TT = { class: "table table-sm table-responsive table-borderless" }, AT = { class: "align-middle px-0" }, OT = { class: "input-group border" }, NT = { class: "d-block p-1 px-2 bg-secondary text-light opacity-50" }, kT = ["onClick"], CT = ["onClick"], ST = {
  key: 0,
  class: "fs-5 ms-2"
}, LT = {
  key: 1,
...
}, AA = { class: "row g-1" }, OA = { class: "col-12 d-flex align-items-center justify-content-center" }, NA = ["for"], kA = { key: 0 }, CA = { key: 0 }, SA = { class: "" }, LA = { class: "" }, IA = {
  key: 1,
  class: "fs-6"
}, $A = {
  key: 0,
  ...
  return g(), b("div", cT, [
    f("div", {
      ...
      e.editfile && e.editfile.presets ? (g(), b("div", uT, [
        f("div", dT, [
          (g(!0), b(J, null, et(e.editfile.types, (a, l) => (g(), b("div", {
            class: "col-md-3",
            key: l
          }, [
            f("span", hT, L(a.extension), 1),
            f("span", fT, L(a.width) + " x " + L(a.height), 1),
            f("span", pT, "~" + L(e.roundFileSize(a.bytes)), 1),
            a ? (g(), b("img", {
              key: 0,
      ...
      e.files && e.files.length ? (g(), b("div", ET, [
        e.params.ui === "list" ? (g(), b("div", wT, [
          f("table", TT, [
            f("tbody", null, [
              (g(!0), b(J, null, et(e.files, (a, l) => (g(), b("tr", { key: l }, [
                f("td", AT, [
                  f("div", OT, [
                    f("span", NT, [
                      f("small", null, L(l + 1), 1)
                    ]),
                    f("span", {
                      ...
                      f("i", {
                        class: C(["bi bi-arrow-up", { "opacity-25": l < 1 }])
                      }, null, 2)
                    ], 8, kT),
                    f("span", {
                      ...
                      f("i", {
                        class: C(["bi bi-arrow-down", { "opacity-25": l >= e.files.length - 1 }])
                      }, null, 2)
                    ], 8, CT),
                    a.isDocument ? (g(), b("span", ST, [
                      f("i", {
                        class: C(["bi bi-filetype-" + a.types.default.extension])
                      }, null, 2)
                    ])) : a.isImage ? (g(), b("span", LT, t[9] || (t[9] = [
                      f("i", { class: "bi bi-file-image" }, null, -1)
                    ]))) : a.isVideo ? (g(), b("span", IT, t[10] || (t[10] = [
                    ...
                    !a.isDocument && a.types && a.types[e.params.thumbnail] ? (g(), b("span", xT, [
                      ...
                      f("ul", PT, [
                        f("li", null, [
                          (g(!0), b(J, null, et(e.params.tags, (u) => (g(), b("span", {
                            ...
                            a.tags && a.tags.indexOf(u.value) >= 0 ? (g(), b("i", jT)) : (g(), b("i", UT)),
                            ct(" " + L(e.translate(u.label ? u.label : u.value)), 1)
                          ], 8, VT))), 128))
                        ]),
                        t[12] || (t[12] = f("li", null, [
        ...
        ])) : (g(!0), b(J, { key: 1 }, et(e.files, (a, l) => (g(), b("div", {
          ...
          f("div", ZT, [
            a.loaded ? (g(), b("div", QT, [
              T("", !0),
              a.types && a.types[e.params.thumbnail] ? (g(), b("div", JT, [
                a.types.default.url ? (g(), b("a", {
                  key: 0,
                  target: "_blank",
                  href: a.types.default.url
                  ...
                  f("ul", gA, [
                    f("li", null, [
                      (g(!0), b(J, null, et(e.params.tags, (u) => (g(), b("span", {
                        ...
                        a.tags && a.tags.indexOf(u.value) >= 0 ? (g(), b("i", bA)) : (g(), b("i", yA)),
                        ct(" " + L(e.translate(u.label ? u.label : u.value)), 1)
                      ], 8, mA))), 128))
                    ]),
                    t[20] || (t[20] = f("li", null, [
                    ...
                    f("li", null, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => e.dropdownSelectAll(a.tags, e.params.tags)
                      }, L(e.translate("Select all")), 9, vA)
                    ]),
                    f("li", null, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => e.dropdownSelectClear(a.tags)
                      }, L(e.translate("Unselect all")), 9, _A)
                    ]),
                    f("li", null, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => e.dropdownSelectInvert(a.tags, e.params.tags)
                      }, L(e.translate("Invert all")), 9, EA)
                    ])
                  ])
                ])) : T("", !0),
                f("button", {
        ...
        f("div", OA, [
          f("label", {
            ...
            e.files && e.params.limit > e.files.length ? (g(), b("span", kA, [
              ...
              ct(" " + L(e.params.text) + " ", 1),
              e.params.limit ? (g(), b("small", CA, [
                t[23] || (t[23] = ct(" ( ")),
                f("strong", SA, L(e.files.length), 1),
                t[24] || (t[24] = ct(" / ")),
                f("span", LA, L(e.params.limit), 1),
                t[25] || (t[25] = ct(" ) "))
              ])) : T("", !0)
        ...
        f("div", RA, [
          f("small", null, [
            e.params.accept ? (g(), b("div", DA, [
              ...
              (g(!0), b(J, null, et(e.params.accept, (a) => (g(), b("strong", {
...
function pO(e, t, s, n, i, r) {
  ...
  return g(), b("div", null, [
    f("div", KA, [
      f("div", GA, [
        f("div", YA, [
          (g(!0), b(J, null, et(e.field.elements, (a) => (g(), b("div", {
            key: a,
            class: C(a.class || "col")
          }, [
            f("small", null, L(a.placeholder ? a.placeholder : a.prefix ? a.prefix : ""), 1)
          ], 2))), 128))
        ])
      ]),
      t[1] || (t[1] = f("div", { class: "col-2 text-nowrap text-end" }, null, -1))
    ]),
    (g(!0), b(J, null, et(e.value, (a, l) => (g(), b("div", {
      class: "row g-1 d-flex align-items-center justify-content-between mb-1",
      key: l
    }, [
      f("div", XA, [
        f("div", ZA, [
          (g(!0), b(J, null, et(a, (u, h) => (g(), b("div", {
            key: h,
            class: C(e.field.elements[h].class || "col")
          }, [
            e.field.elements[h].template ? (g(), b("span", {
              key: 0,
              innerHTML: e.getValueOrFunction(e.field.elements[h].template, e.value[l])
            }, null, 8, QA)) : (g(), b("div", JA, [
              e.field.elements[h].type == "select" && e.value[l][h] ? (g(), ze(o, {
                key: 0,
      ...
      f("div", aO, [
        f("div", lO, [
          (g(!0), b(J, null, et(e.field.elements, (a) => (g(), b("div", {
            ...
            f("div", cO, [
              a.prefix ? (g(), b("span", uO, L(a.prefix), 1)) : T("", !0),
              ...
              a.suffix ? (g(), b("span", hO, L(a.suffix), 1)) : T("", !0)
            ]),
            T("", !0)
          ], 2))), 128))
        ])
...
const gO = /* @__PURE__ */ oe(zA, [["render", pO]]), mO = {
  ...
  key: 1,
  class: "input-group"
}, NO = ["innerHTML"], kO = ["name", "id", "onUpdate:modelValue", "minlength", "maxlength", "placeholder", "disabled", "readonly", "required"], CO = ["name", "id", "onUpdate:modelValue", "min", "max", "step", "placeholder", "disabled", "readonly", "required"], SO = ["type", "name", "id", "onUpdate:modelValue", "min", "max", "disabled", "readonly", "required"], LO = {
  key: 4,
  class: "form-check"
...
function tN(e, t, s, n, i, r) {
  ...
  return g(), b("div", yO, [
    (g(!0), b(J, null, et(e.settings.form.groups, (h) => (g(), b("div", {
      key: h,
      class: C([h.class ? h.class : "col-md-12"])
    }, [
      h.title ? (g(), b("h2", {
        key: 0,
      ...
      e.item && h.fields ? (g(), b("div", _O, [
        (g(!0), b(J, null, et(h.fields, (d) => (g(), b("div", {
          class: C([e.getValueOrFunction(d.class ? d.class : "col-md-12"), "input_type_" + d.type]),
          key: d
        }, [
          f("div", EO, [
            d.label ? (g(), b("span", wO, [
              ["html", "image", "upload"].indexOf(d.type) >= 0 ? (g(), b("label", {
                key: 0,
                class: C([{ required: d.required }, "form-label text-secondary mb-1"])
              }, [
                ct(L(d.label ? d.label : e.translate(d.name)) + " ", 1),
                d.maxlength ? (g(), b("span", TO, L(e.item[d.name] ? e.item[d.name].length : 0) + " / " + L(d.maxlength), 1)) : T("", !0)
              ], 2)) : (g(), b("label", {
                key: 1,
                class: C([{ required: d.required }, "form-label text-secondary mb-1"]),
            ...
            ["html", "image", "list", "addresses", "template"].indexOf(d.type) < 0 ? (g(), b("div", OO, [
              d.prefix ? (g(), b("span", {
                key: 0,
                class: "input-group-text",
              ...
              d.type == "text" ? at((g(), b("input", {
                key: 1,
                class: C(["form-control", e.getValueOrFunction(d.inputclass ? d.inputclass : "", { field: d, item: e.item })]),
                type: "text",
                name: d.name,
                id: e.formId + "_" + d.name,
                "onUpdate:modelValue": (m) => e.item[d.name] = m,
              ...
              ["date", "datetime", "datetime-local"].indexOf(d.type) >= 0 ? at((g(), b("input", {
                key: 3,
                class: C(["form-control", e.getValueOrFunction(d.inputclass ? d.inputclass : "", { field: d, item: e.item })]),
                type: d.type,
                name: d.name,
              ...
              d.type == "checkbox" ? (g(), b("div", LO, [
                at(f("input", {
                  class: C(["form-check-input", e.getValueOrFunction(d.inputclass ? d.inputclass : "", { field: d, item: e.item })]),
                  type: "checkbox",
                  name: d.name,
                  id: e.formId + "_" + d.name,
              ...
              d.type == "select" && (!d.relation || d.relation && d.relation.items) ? (g(), ze(o, {
                key: 6,
              ...
              d.type == "textarea" ? at((g(), b("textarea", {
                key: 7,
                class: C(["form-control", e.getValueOrFunction(d.inputclass ? d.inputclass : "", { field: d, item: e.item })]),
                name: d.name,
                id: e.formId + "_" + d.name,
            ...
            d.type == "image" || d.type == "upload" ? (g(), ze(l, {
              key: 3,
              modelValue: e.item[d.name],
              "onUpdate:modelValue": (m) => e.item[d.name] = m,
              class: C([d.class]),
            ...
            d.type == "list" && (!d.relation || d.relation && d.relation.items) ? (g(), ze(u, {
              key: 4,
              modelValue: e.item[d.name],
              "onUpdate:modelValue": (m) => e.item[d.name] = m,
              field: d,
            ...
            d.type == "dropdown" && e.item[d.name] ? (g(), b("div", {
              key: 5,
              class: C([d.class])
            }, [
              f("div", DO, [
                ...
                f("ul", qO, [
                  f("li", null, [
                    (g(!0), b(J, null, et(d.options, (m) => (g(), b("span", {
                      key: m,
                      class: C(["dropdown-item cursor-pointer", { selected: e.item[d.name].indexOf(m.value) >= 0 }]),
                      onClick: (y) => e.dropdownSelectToggleOne(d, e.item[d.name], m)
                    }, [
                      e.item[d.name].indexOf(m.value) >= 0 ? (g(), b("i", PO)) : (g(), b("i", VO)),
                      ct(" " + L(e.translate(m.label ? m.label : m.value)), 1)
                    ], 10, BO))), 128))
                  ]),
                  t[0] || (t[0] = f("li", null, [
                    f("hr", { class: "dropdown-divider" })
                  ...
                  f("li", null, [
                    f("span", {
                      class: "dropdown-item cursor-pointer",
                      onClick: (m) => e.dropdownSelectAll(e.item[d.name], d.options)
                    }, L(e.translate("Select all")), 9, jO)
                  ]),
                  f("li", null, [
                    f("span", {
                      class: "dropdown-item cursor-pointer",
                      onClick: (m) => e.dropdownSelectClear(e.item[d.name])
                    }, L(e.translate("Unselect all")), 9, UO)
                  ]),
                  f("li", null, [
                    f("span", {
                      class: "dropdown-item cursor-pointer",
                      onClick: (m) => e.dropdownSelectInvert(e.item[d.name], d.options)
                    }, L(e.translate("Invert all")), 9, FO)
                  ])
                ])
              ]),
              e.item[d.name].length ? (g(), b("span", HO, [
                (g(!0), b(J, null, et(e.item[d.name], (m) => (g(), b("span", {
                  ...
                  ct(L(e.translate(m)) + " ", 1),
                  t[1] || (t[1] = f("i", { class: "bi bi-x" }, null, -1))
                ], 10, WO))), 128))
              ])) : T("", !0)
            ], 2)) : T("", !0),
            d.type == "addresses" ? (g(), b("span", zO, [
              e.item[d.name] ? (g(), b("div", KO, [
                (g(!0), b(J, null, et(e.item[d.name], (m) => (g(), b("div", { key: m }, [
                  ct(L(m) + " ", 1),
                  f("label", {
              ...
              f("button", {
                ...
                onClick: (m) => e.insertAddress(d.name)
              }, " Add ", 8, XO)
            ])) : T("", !0),
            d.type == "template" ? (g(), b("div", {
              key: 7,
  ...
  return e.item ? (g(), b("form", {
    ...
    f("div", rN, [
      e.loaded ? (g(), b("h5", oN, [
        ...
        e.settings.form.title && typeof e.settings.form.title == "string" ? (g(), b("span", lN, L(e.translate(e.settings.form.title)), 1)) : T("", !0),
        e.settings.form.title ? T("", !0) : (g(), b("span", cN, L(e.translate("Edit")), 1)),
        e.item[e.settings.pkey] ? (g(), b("small", uN, [
          t[2] || (t[2] = f("span", { class: "text-muted fw-light" }, "id", -1)),
          ct(" " + L(e.item[e.settings.pkey]), 1)
        ])) : T("", !0)
      ])) : T("", !0),
      e.message.form ? (g(), b("span", dN, [
        f("span", {
      ...
      e.settings.form.control ? (g(), b("div", {
        ...
        e.messages.form.length ? (g(), b("span", gN, [
          f("div", mN, [
            ...
            f("ul", yN, [
              (g(!0), b(J, null, et(e.messages.form, (a) => (g(), b("li", { key: a }, [
                f("span", {
                  class: C(["dropdown-item disabled", ["text-" + a.priority]])
                }, [
                  f("small", vN, L(a.datetime), 1),
                  f("span", {
                    innerHTML: a.msg
                  }, null, 8, _N)
                ], 2)
        ...
        (g(!0), b(J, null, et(e.settings.form.control.buttons, (a) => (g(), b("span", {
          key: a.action
        }, [
          a.dropdowns ? T("", !0) : (g(), b("button", {
            ...
            ct(" " + L(e.translate(a.title)), 1)
          ], 10, EN)),
          a.dropdowns ? (g(), b("div", wN, [
            f("button", {
              type: "button",
            ...
            f("ul", AN, [
              (g(!0), b(J, null, et(a.dropdowns, (l) => (g(), b("li", { key: l }, [
                f("span", {
                  class: C([l.class ? l.class : ""]),
    ...
    e.settings.debug > 1 ? (g(), b("pre", CN, "        " + L(e.item) + `
    `, 1)) : T("", !0)
  ], 42, iN)) : T("", !0);
}
const Ih = /* @__PURE__ */ oe(nN, [["render", SN]]), LN = {
...
}, $N = { class: "dropdown d-inline-block m-1" }, xN = { class: "mx-1" }, MN = { key: 0 }, RN = {
  key: 0,
...
function ZN(e, t, s, n, i, r) {
  return s.config.pagination.hidden ? T("", !0) : (g(), b("nav", IN, [
    f("div", null, [
      f("div", $N, [
        f("button", {
          ...
          at(f("span", xN, [
            f("strong", null, L(s.config.pagination.from) + "-" + L(s.config.pagination.to), 1),
            s.config.pagination.total ? (g(), b("span", MN, " / " + L(s.config.pagination.total), 1)) : T("", !0)
          ], 512), [
            [Ss, s.config.pagination.from > 0]
          ])
        ], 2),
        s.config.pagination.limits ? (g(), b("ul", RN, [
          f("li", null, [
            (g(!0), b(J, null, et(s.config.pagination.limits, (o) => (g(), b("span", {
              class: C(["dropdown-item cursor-pointer", { selected: s.config.pagination.limit == o }]),
              key: o,
              onClick: (a) => r.setPageLimit(o)
            }, [
              f("strong", null, L(o), 1),
              f("small", qN, L(r.translate("row")) + "/" + L(r.translate("page")), 1),
              s.config.pagination.limit == o ? (g(), b("i", BN)) : T("", !0),
              s.config.pagination.limit != o ? (g(), b("i", PN)) : T("", !0)
            ], 10, DN))), 128))
          ])
        ])) : T("", !0)
      ]),
    ...
    f("ul", jN, [
      ...
      (g(!0), b(J, null, et(s.config.pagination.numbers, (o) => (g(), b("li", {
        key: o,
        class: "page-item"
      }, [
        f("a", {
...
const QN = /* @__PURE__ */ oe(LN, [["render", ZN]]), bu = sl(), JN = {
  ...
  key: 2,
  class: "dropdown d-inline-block"
}, Ak = { class: "mx-1" }, Ok = { class: "dropdown-menu" }, Nk = ["onClick"], kk = { class: "vua-table-header" }, Ck = ["width"], Sk = ["onClick"], Lk = ["innerHTML"], Ik = {
  key: 0,
  class: "bi bi-arrow-down"
}, $k = {
  key: 1,
  class: "bi bi-arrow-up"
}, xk = { key: 0 }, Mk = ["disabled", "onClick"], Rk = {
  key: 0,
  ...
  key: 2,
  class: "input-group input-group-sm my-1"
}, Hk = ["onUpdate:modelValue", "disabled"], Wk = { value: "=" }, zk = { value: ">" }, Kk = { value: ">=" }, Gk = { value: "<" }, Yk = { value: "<=" }, Xk = ["onUpdate:modelValue", "disabled"], Zk = ["value"], Qk = ["onUpdate:modelValue", "disabled", "min", "max"], Jk = ["disabled", "onClick"], t2 = { key: 3 }, e2 = {
  key: 0,
  class: "dropdown"
}, s2 = {
  ...
  "data-bs-toggle": "dropdown",
  "aria-expanded": "false"
}, n2 = { class: "dropdown-menu" }, i2 = ["onClick"], r2 = {
  key: 0,
  class: "bi bi-check-square"
}, o2 = {
  key: 1,
  class: "bi bi-square"
}, a2 = { key: 0 }, l2 = { key: 1 }, c2 = ["onClick"], u2 = { key: 2 }, d2 = ["onClick"], h2 = { key: 3 }, f2 = ["onClick"], p2 = {
  key: 1,
  class: "input-group input-group-sm my-1"
}, g2 = ["onUpdate:modelValue", "multiple"], m2 = ["value"], b2 = ["disabled", "onClick"], y2 = {
  key: 4,
  class: "input-group input-group-sm my-1"
}, v2 = ["onUpdate:modelValue"], _2 = { value: "=" }, E2 = { value: ">" }, w2 = { value: ">=" }, T2 = { value: "<" }, A2 = { value: "<=" }, O2 = ["onUpdate:modelValue"], N2 = ["value"], k2 = ["type", "onUpdate:modelValue"], C2 = ["disabled", "onClick"], S2 = ["disabled", "onClick"], L2 = { class: "align-middle" }, I2 = ["data-label", "width", "onClick"], $2 = {
  key: 0,
  class: "d-inline-block w-100 px-1"
}, x2 = ["innerHTML"], M2 = { key: 1 }, R2 = ["innerHTML"], D2 = ["aria-valuenow", "aria-valuemax"], q2 = { key: 0 }, B2 = {
  key: 4,
  class: "input-group input-group-sm"
}, P2 = ["innerHTML"], V2 = ["type", "onChange", "onUpdate:modelValue"], j2 = ["onChange", "onUpdate:modelValue"], U2 = ["value"], F2 = ["innerHTML"], H2 = { key: 5 }, W2 = ["disabled", "onClick"], z2 = ["innerHTML"], K2 = { key: 2 }, G2 = { key: 0 }, Y2 = ["colspan"], X2 = { class: "row g-3 align-items-center" }, Z2 = { class: "col-form-label" }, Q2 = ["type", "onUpdate:modelValue", "onChange"], J2 = ["onUpdate:modelValue", "onChange"], tC = ["onUpdate:modelValue", "onChange"], eC = ["value"], sC = ["innerHTML"], nC = {
  key: 0,
  class: "bg-light text-dark"
}, iC = {
  key: 0,
  class: "vua-table-bulk border-info"
}, rC = ["data-label", "width"], oC = {
  key: 0,
  class: "d-inline-block w-100 px-1"
}, aC = {
  key: 1,
  class: "input-group input-group-sm my-1"
}, lC = ["type", "disabled", "onChange", "onUpdate:modelValue"], cC = ["disabled", "onChange", "onUpdate:modelValue"], uC = ["value"], dC = ["onClick"], hC = {
  key: 0,
  class: "bi bi-square text-secondary"
}, fC = {
  key: 1,
  class: "bi bi-check-square"
}, pC = { key: 2 }, gC = ["disabled", "onClick"], mC = ["innerHTML"], bC = { key: 2 }, yC = ["id"], vC = { class: "modal-dialog modal-xl" }, _C = { class: "modal-content h-100" };
function EC(e, t, s, n, i, r) {
  ...
  return g(), b("div", null, [
    r.authAndSettings() ? (g(), b("div", {
      ...
      f("div", ek, [
        f("div", sk, [
          f("div", nk, [
            s.settings.table.title ? (g(), b("h5", ik, L(s.settings.table.title), 1)) : T("", !0),
            ...
            f("div", ck, [
              ...
              f("ul", dk, [
                (g(!0), b(J, null, et(i.messages.table, (l) => (g(), b("li", { key: l }, [
                  f("span", {
                    class: C(["dropdown-item", ["text-" + l.priority]])
                  }, [
                    f("small", hk, L(l.datetime), 1),
                    f("span", {
                      class: "fw-bold",
                      innerHTML: l.msg
                    }, null, 8, fk)
          ...
          l.action === "TABLE_COLUMNS" ? (g(), b("div", gk, [
            f("button", {
              ...
              at(f("span", mk, [
                ...
                ct(" " + L(r.translate(l.title)) + " ", 1),
                r.countHiddenColumns() ? (g(), b("span", bk, " ( " + L(r.countHiddenColumns()) + " " + L(r.translate("hidden")) + " ) ", 1)) : T("", !0)
              ], 512), [
            ...
            f("ul", yk, [
              ...
              f("li", null, [
                ...
                }, L(r.translate("Visible all")), 1)
              ]),
              f("li", null, [
                f("span", {
                  class: "dropdown-item cursor-pointer",
                  onClick: t[1] || (t[1] = (u) => r.toggleColumn(!1))
                }, L(r.translate("Hidden all")), 1)
              ])
            ])
          ])) : T("", !0),
      ...
      s.settings.table ? (g(), b("table", {
        ...
        f("thead", null, [
          f("tr", kk, [
            (g(!0), b(J, null, et(s.settings.table.columns, (l) => (g(), b("th", {
              class: C(["", [l.header ? l.header.class : ""]]),
              style: Qn([l.hidden ? "display: none" : ""]),
              key: l,
              width: l.width
            }, [
              f("span", {
                class: C(["d-inline-block no-select text-nowrap", { "cursor-pointer": r.isSortable(l) }]),
                ...
                i.config.order[l.name] ? (g(), b("span", {
                  ...
                  ct(" " + L(i.config.order[l.name].idx + 1), 1)
                ], 2)) : T("", !0)
              ], 10, Sk),
          ...
          r.countFilters() ? (g(), b("tr", Rk, [
            (g(!0), b(J, null, et(s.settings.table.columns, (l) => (g(), b("th", {
              style: Qn([l.hidden ? "display: none" : ""]),
              key: l,
              width: l.width,
              class: C([l.filter ? l.filter.class : ""])
            }, [
              ...
              l.filter && l.filter.type == "number" ? (g(), b("div", Fk, [
                l.filter.operators == !0 ? at((g(), b("select", {
                  ...
                  f("option", Wk, L(r.translate("=")), 1),
                  f("option", zk, L(r.translate(">")), 1),
                  f("option", Kk, L(r.translate(">=")), 1),
                  f("option", Gk, L(r.translate("<")), 1),
                  f("option", Yk, L(r.translate("<=")), 1)
                ], 40, Hk)), [
              ...
              l.filter && l.filter.type == "select" ? (g(), b("div", t2, [
                l.filter.dropdown ? (g(), b("div", e2, [
                  f("button", s2, L(l.filter.multiple ? l.filter.value.length + " selected" : l.filter.value ? l.filter.value : "not selected"), 1),
                  f("ul", n2, [
                    f("li", null, [
                      (g(!0), b(J, null, et(l.filter.options, (u) => (g(), b("span", {
                        key: u,
                        class: C(["dropdown-item cursor-pointer", { selected: l.filter.multiple ? l.filter.value.indexOf(u.value) >= 0 : l.filter.value === u.value }]),
                        onClick: (h) => r.dropdownSelectToggleOne(l.filter, u)
                      }, [
                        (l.filter.multiple ? l.filter.value.indexOf(u.value) >= 0 : l.filter.value === u.value) ? (g(), b("i", r2)) : (g(), b("i", o2)),
                        ct(" " + L(r.translate(u.label ? u.label : u.value)), 1)
                      ], 10, i2))), 128))
                    ]),
                    l.filter.multiple ? (g(), b("li", a2, t[19] || (t[19] = [
                      f("hr", { class: "dropdown-divider" }, null, -1)
                    ]))) : T("", !0),
                    l.filter.multiple ? (g(), b("li", l2, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => r.dropdownSelectAll(l.filter.value, l.filter.options)
                      }, L(r.translate("Select all")), 9, c2)
                    ])) : T("", !0),
                    l.filter.multiple ? (g(), b("li", u2, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => r.dropdownSelectClear(l.filter.value)
                      }, L(r.translate("Unselect all")), 9, d2)
                    ])) : T("", !0),
                    l.filter.multiple ? (g(), b("li", h2, [
                      f("span", {
                        class: "dropdown-item cursor-pointer",
                        onClick: (u) => r.dropdownSelectInvert(l.filter.value, l.filter.options)
                      }, L(r.translate("Invert all")), 9, f2)
                    ])) : T("", !0)
                  ])
                ])) : (g(), b("div", p2, [
                  at(f("select", {
                    ...
                    (g(!0), b(J, null, et(l.filter.options, (u) => (g(), b("option", {
                      key: u,
                      value: u.value
                    }, L(r.translate(u.label ? u.label : u.value)), 9, m2))), 128))
                  ], 40, g2), [
                    [ke, l.filter.value]
                  ]),
                  l.filter.buttonx && l.filter.buttonx != !1 ? (g(), b("button", {
              ...
              l.filter && (l.filter.type == "datetime-local" || l.filter.type == "date") ? (g(), b("div", y2, [
                l.filter.operators == !0 ? at((g(), b("select", {
                  key: 0,
                  "onUpdate:modelValue": (u) => l.filter.operator = u,
                  ...
                  f("option", _2, L(r.translate("=")), 1),
                  f("option", E2, L(r.translate(">")), 1),
                  f("option", w2, L(r.translate(">=")), 1),
                  f("option", T2, L(r.translate("<")), 1),
                  f("option", A2, L(r.translate("<=")), 1)
                ], 40, v2)), [
                  [ke, l.filter.operator]
                ]) : T("", !0),
                l.filter.operators && l.filter.operators.length > 0 ? at((g(), b("select", {
                  ...
                  (g(!0), b(J, null, et(l.filter.operators, (u) => (g(), b("option", {
                    key: u,
                    value: u.value
                  }, L(r.translate(u.label)), 9, N2))), 128))
                ], 40, O2)), [
                  [ke, l.filter.operator]
                ]) : T("", !0),
                at(f("input", {
        ...
        f("tbody", null, [
          (g(!0), b(J, null, et(this.items, (l, u) => (g(), b(J, {
            ...
            f("tr", L2, [
              (g(!0), b(J, null, et(s.settings.table.columns, (h) => (g(), b("td", {
                ...
                !h.template && !h.input && !h.progressbar ? (g(), b("span", M2, L(r.tableCellValue(h.name, l, u, h)), 1)) : T("", !0),
                h.template ? (g(), b("span", {
                  key: 2,
                  innerHTML: r.tableCellTemplate(h.template, l, u, h)
                }, null, 8, R2)) : T("", !0),
                h.progressbar ? (g(), b("div", {
                  key: 3,
                  class: "progress",
                  role: "progressbar",
                  ...
                  f("div", {
                    class: C(["progress-bar", [h.progressbar.class]]),
                    style: Qn({ width: Math.round(l[h.name] / h.progressbar.max * 100) + "%" })
                  }, [
                    h.progressbar.value ? (g(), b("span", q2, L(l[h.name]), 1)) : T("", !0)
                  ], 6)
                ], 8, D2)) : T("", !0),
                h.input ? (g(), b("div", B2, [
                  h.input.prefix ? (g(), b("span", {
                    key: 0,
                    class: "input-group-text",
                  ...
                  ["text", "number", "date", "datetime-local"].indexOf(
                    ...
                    key: 1,
                    type: h.input.type,
                    class: C(["form-control form-control-sm", r.getValueOrFunction(h.input.class, {
                      column: h,
                      item: l
                    })]),
                  ...
                  h.input.type == "select" ? at((g(), b("select", {
                    key: 2,
                    class: C(["form-select form-select-sm pe-0", r.getValueOrFunction(h.input.class, {
                      column: h,
                      item: l
                    })]),
                    onChange: (d) => r.onRowInputChange(l[h.name], h, l, u),
                    ...
                    (g(!0), b(J, null, et(h.input.options, (d) => (g(), b("option", {
                      value: d.value,
                      key: d
                    }, L(r.translate(d.label)), 9, U2))), 128))
                  ], 42, j2)), [
                    [ke, l[h.name]]
                  ]) : T("", !0),
                  h.input.suffix ? (g(), b("span", {
                    key: 3,
                    class: "input-group-text",
                ...
                h.buttons ? (g(), b("span", H2, [
                  (g(!0), b(J, null, et(h.buttons, (d) => (g(), b("span", {
                    key: d.action
                  }, [
                    d.hidden ? T("", !0) : (g(), b("button", {
                      key: 0,
                      type: "button",
                      ...
                      }, null, 8, z2)) : (g(), b("span", K2, L(r.translate(d.title)), 1))
                    ], 10, W2))
                  ]))), 128))
                ])) : T("", !0)
              ], 14, I2))), 128))
            ]),
            s.settings.table.details && i.details.indexOf(l[s.settings.pkey]) >= 0 ? (g(), b("tr", G2, [
              f("td", {
                class: C([s.settings.table.details.class]),
                colspan: s.settings.table.columns.length
              }, [
                (g(!0), b(J, null, et(s.settings.table.details.fields, (h) => (g(), b("div", {
                  class: "m-0",
                  key: h
                }, [
                  f("div", X2, [
                    f("div", {
                      class: C(["col text-end", [h.class]])
                    }, [
                      f("label", Z2, L(h.label), 1)
                    ], 2),
                    f("div", {
                      class: C(["col", [h.input.class]])
                    }, [
                      ["select", "textarea"].indexOf(h.input.type) < 0 ? at((g(), b("input", {
                        key: 0,
                        type: h.input.type,
                        class: "form-control form-control-sm",
                        "onUpdate:modelValue": (d) => l[h.name] = d,
                      ...
                      h.input.type == "textarea" ? at((g(), b("textarea", {
                        key: 1,
                        class: "form-control form-control-sm",
                        rows: "3",
                        "onUpdate:modelValue": (d) => l[h.name] = d,
                    ...
                    `, 40, J2)), [
                      ...
                      h.input.type == "select" ? at((g(), b("select", {
                        ...
                        (g(!0), b(J, null, et(h.input.options, (d) => (g(), b("option", {
                          value: d.value,
                          key: d
                        }, L(r.translate(d.label)), 9, eC))), 128))
                      ], 40, tC)), [
                        [ke, l[h.name]]
                      ]) : T("", !0)
                    ], 2)
                ...
                s.settings.debug > 1 ? (g(), b("pre", nC, "                  " + L(l) + `
                `, 1)) : T("", !0)
              ], 10, Y2)
            ])) : T("", !0)
          ], 64))), 128))
          ...
          i.selected.length > 0 ? (g(), b("tr", iC, [
            (g(!0), b(J, null, et(s.settings.table.columns, (l) => (g(), b("td", {
              ...
              l.index ? (g(), b("div", oC, [
                ...
                }, L(i.selected.length), 1)
              ])) : T("", !0),
              l.input && l.bulk && l.bulk.enabled ? (g(), b("div", aC, [
                ["text", "number", "date", "datetime-local"].indexOf(
                  l.input.type
                ) >= 0 ? at((g(), b("input", {
                  key: 0,
                  type: l.input.type,
                  class: C(["form-control form-control-sm", l.input.class]),
                ...
                l.input.type == "select" ? at((g(), b("select", {
                  key: 1,
                  class: C(["form-select form-select-sm pe-0", l.input.class]),
                  disabled: i.bulkinputs.indexOf(l.name) < 0,
                  onChange: (u) => r.onBulkInputChange(i.bulkitem[l.name], i.bulkitem, l),
                  "onUpdate:modelValue": (u) => i.bulkitem[l.name] = u
                }, [
                  (g(!0), b(J, null, et(l.input.options, (u) => (g(), b("option", {
                    value: u.value,
                    key: u
                  }, L(r.translate(u.label)), 9, uC))), 128))
                ], 42, cC)), [
                ...
                f("span", {
                  ...
                  i.bulkitem[l.name] === void 0 ? (g(), b("i", hC)) : (g(), b("i", fC))
                ], 8, dC)
              ])) : T("", !0),
              l.bulk ? (g(), b("span", pC, [
                (g(!0), b(J, null, et(l.bulk.buttons, (u) => (g(), b("span", {
                  ...
                  f("button", {
                    ...
                    }, null, 8, mC)) : (g(), b("span", bC, L(r.translate(u.title)), 1))
                  ], 10, gC)
                ]))), 128))
              ])) : T("", !0)
            ], 14, rC))), 128))
...
const wC = /* @__PURE__ */ oe(JN, [["render", EC]]), TC = {
  name: "VuAdmin",
  props: {
    entity: {
      type: String,
...
}, AC = TC, OC = { key: 0 }, NC = ["data-bs-theme"];
function kC(e, t, s, n, i, r) {
  const o = pe("vu-admin-table");
  return e.entity && e.settings ? (g(), b("div", OC, [
    e.auth ? (g(), b("div", {
      key: 0,
      class: "vu-admin",
      "data-bs-theme": [e.settings.theme]
...
const $C = {
  ...
  key: 0,
  class: "vua-auth"
}, RC = { class: "col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 mx-auto" }, DC = { class: "text-center mt-2 mb-4" }, qC = { key: 0 }, BC = { key: 1 }, PC = { key: 2 }, VC = { key: 3 }, jC = { key: 0 }, UC = ["innerHTML"], FC = { class: "d-flex justify-content-between" }, HC = { class: "mb-3" }, WC = {
  for: "email",
  class: "form-label text-primary"
}, zC = { class: "input-group" }, KC = ["type", "placeholder"], GC = ["innerHTML"], YC = { class: "mb-3" }, XC = {
  for: "password",
  class: "form-label text-primary"
}, ZC = { class: "input-group" }, QC = ["type", "placeholder", "pattern", "minlength"], JC = {
  key: 0,
  class: "bi bi-eye"
}, tS = {
  key: 1,
  ...
  key: 0,
  class: "text-danger"
}, rS = { class: "input-group" }, oS = ["type", "placeholder", "minlength"], aS = {
  key: 0,
  class: "bi bi-eye"
}, lS = {
  key: 1,
  class: "bi bi-eye-slash"
}, cS = ["innerHTML"], uS = { class: "mb-3 text-center" }, dS = ["data-sitekey"], hS = {
  key: 1,
  class: "mb-4 text-center"
}, fS = {
  key: 2,
  class: "d-flex mb-4"
}, pS = { key: 3 }, gS = { key: 0 }, mS = ["for", "innerHTML"], bS = { class: "input-group" }, yS = ["innerHTML"], vS = ["required", "onUpdate:modelValue", "multiple"], _S = ["value", "innerHTML"], ES = ["id", "name", "type", "onUpdate:modelValue", "placeholder", "required"], wS = ["innerHTML"], TS = ["innerHTML"], AS = {
  key: 0,
  class: "form-check"
}, OS = ["id", "name", "onUpdate:modelValue", "required"], NS = ["for", "innerHTML"], kS = {
  key: 4,
  class: "mt-4"
}, CS = ["innerHTML"], SS = { class: "mt-4 d-flex justify-content-between" }, LS = {
  key: 0,
...
}, xS = ["innerHTML"], MS = { class: "mt-2 text-end" }, RS = ["id"], DS = { class: "modal-dialog modal-xl" }, qS = { class: "modal-content h-100" };
function BS(e, t, s, n, i, r) {
  const o = pe("VuAdminForm");
  return e.auth && e.auth.visible ? (g(), b("div", MC, [
    f("div", {
      ...
      f("div", RC, [
        f("div", {
          ...
          f("h1", DC, [
            e.auth.panel == "forgot" ? (g(), b("span", qC, " Elfelejtett jelszó ")) : T("", !0),
            e.auth.panel == "registration" ? (g(), b("span", BC, " Regisztráció ")) : T("", !0),
            e.auth.panel == "help" ? (g(), b("span", PC, " Segítség ")) : T("", !0),
            e.auth.panel == "login" ? (g(), b("span", VC, " Bejelentkezés ")) : T("", !0)
          ]),
          e.auth.panel == "help" ? (g(), b("div", jC, [
            f("div", {
            ...
            f("div", HC, [
              f("label", WC, L(e.settings.username.label), 1),
              f("div", zC, [
            ...
            e.auth.panel != "forgot" ? (g(), b(J, { key: 0 }, [
              f("div", YC, [
                f("label", XC, L(e.settings.password.label), 1),
                f("div", ZC, [
                  ...
                  f("span", {
                    ...
                    e.settings.password.type == "password" ? (g(), b("i", JC)) : (g(), b("i", tS))
                  ], 2)
                ]),
              ...
              e.auth.panel === "registration" ? (g(), b("div", sS, [
                f("label", nS, [
                  ct(L(e.settings.password_again.label) + " ", 1),
                  e.password_again.length > 0 && e.password_again != e.password ? (g(), b("small", iS, " ( a két jelszó nem egyezik ) ")) : T("", !0)
                ]),
                f("div", rS, [
                  e.settings.password.icon ? (g(), b("span", {
                    key: 0,
                  ...
                  f("span", {
                    ...
                    e.settings.password_again.type == "password" ? (g(), b("i", aS)) : (g(), b("i", lS))
                  ], 2)
                ]),
            ...
            e.auth.panel == "forgot" ? (g(), b("div", fS, t[20] || (t[20] = [
            ...
            e.auth.panel == "registration" ? (g(), b("div", pS, [
              (g(!0), b(J, null, et(e.settings.inputs, (a, l) => (g(), b("div", {
                key: l,
                class: "mb-4"
              }, [
                a.hidden ? T("", !0) : (g(), b("div", gS, [
                  f("label", {
                    for: l,
                    class: "form-label text-primary",
                  ...
                  f("div", bS, [
                    a.prefix ? (g(), b("span", {
                      key: 0,
                      class: C(["input-group-text", { "rounded-bottom-0": a.help }]),
                      innerHTML: e.getValueOrFunction(a.prefix)
                    }, null, 10, yS)) : T("", !0),
                    a.type == "select" ? at((g(), b("select", {
                      key: 1,
                      class: "form-select",
                      required: a.required,
                      ...
                      (g(!0), b(J, null, et(a.options, (u) => (g(), b("option", {
                        key: u,
                        value: u.value,
                      ...
                      type: a.type,
                      "onUpdate:modelValue": (u) => e.inputs[l] = u,
                      class: C(["form-control", { "rounded-bottom-0": a.help }]),
            ...
            (g(!0), b(J, null, et(e.settings.accepts, (a) => (g(), b("div", { key: a }, [
              a.panels.indexOf(e.auth.panel) >= 0 ? (g(), b("div", AS, [
                at(f("input", {
                  type: "checkbox",
            ...
            e.auth.panel == "registration" && e.settings.registration ? (g(), b("div", kS, [
            ...
            f("div", SS, [
              ...
              f("button", {
                ...
                ct(L(e.auth.panel == "forgot" ? "Új jelszó kérése" : e.auth.panel == "registration" ? "Regisztráció" : "Bejelentkezés") + " ", 1),
                e.auth.panel == "registration" ? (g(), b("i", LS)) : (g(), b("i", IS))
              ], 2)
            ]),
            e.responseMessage ? (g(), b("div", $S, [
              f("div", {
...
const PS = /* @__PURE__ */ oe(xC, [["render", BS]]);
sl();
const VS = {
  name: "VuUserButton",
  props: {
...
}, zS = ["onClick", "innerHTML"], KS = {
  key: 1,
  class: "d-inline-block"
}, GS = ["innerHTML"];
function YS(e, t, s, n, i, r) {
  return !e.auth.user && e.panel != "login" || e.panel == "login" ? (g(), b("div", US, [
    e.auth.user ? (g(), b("div", FS, [
      f("button", {
      ...
      f("ul", WS, [
        (g(!0), b(J, null, et(e.settings.dropdowns, (o) => (g(), b("li", {
          key: o,
          class: C([o.class]),
...
const XS = /* @__PURE__ */ oe(jS, [["render", YS]]), iL = {
  install(e) {
    e.component("VuAdmin", CC), e.component("VuAuth", PS), e.component("VuUserButton", XS);
  }
};
export {
  CC as VuAdmin,
