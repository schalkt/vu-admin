...
var Ey = {
	...
	methods: {
		initQuillEditor() {
			let e = Sy.import("parchment"), t = new e.ClassAttributor("align", "text", {
				scope: e.Scope.BLOCK,
				whitelist: [
					"center",
					"end",
			...
			Sy.register(t, !0), Sy.register("attributors/class/align", t, !0);
			let n = Sy.import("blots/block");
			class r extends n {}
			r.tagName = "div", Sy.register(r, !0);
			let i = Sy.import("blots/embed");
			class a extends i {
				static create(e) {
			...
			a.blotName = "iframe", a.tagName = "iframe", a.className = "ql-iframe", Sy.register(a);
			let o = Ty({
				theme: "snow",
				modules: { toolbar: {
					container: [
			...
			this.quill = new Sy(this.$refs.editor, o);
			let s = (this.modelValue || "").trim();
			this.setHtmlContent(s), this.$nextTick(() => {
