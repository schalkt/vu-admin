...
L_({}, {
	createAtomBlockMarkdownSpec: () => nx,
	createBlockMarkdownSpec: () => rx,
	createInlineMarkdownSpec: () => ox,
	parseAttributes: () => ex,
	parseIndentedBlocks: () => sx,
	renderNestedMarkdownContent: () => cx,
	serializeAttributes: () => tx
});
function ex(e) {
	if (!e?.trim()) return {};
...
function nx(e) {
	let { nodeName: t, name: n, parseAttributes: r = ex, serializeAttributes: i = tx, defaultAttributes: a = {}, requiredAttributes: o = [], allowedAttributes: s } = e, c = n || t, l = (e) => {
		if (!s) return e;
		let t = {};
		return s.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function rx(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = ex, serializeAttributes: a = tx, defaultAttributes: o = {}, content: s = "block", allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function ox(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = ix, serializeAttributes: a = ax, defaultAttributes: o = {}, selfClosing: s = !1, allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
...
var px = class extends Jb {
	constructor(e = {}) {
		return super(e), this.contentComponent = null, this.appContext = null, this.reactiveState = fx(this.view.state), this.reactiveExtensionStorage = fx(this.extensionStorage), this.on("beforeTransaction", ({ nextState: e }) => {
...
var hx = (e, t) => {
	...
	renderHTML({ HTMLAttributes: e }) {
		return /* @__PURE__ */ hx("blockquote", {
			...dy(this.options.HTMLAttributes, e),
			children: /* @__PURE__ */ hx("slot", {})
		});
	},
	parseMarkdown: (e, t) => {
...
}), vx = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, yx = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, bx = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, xx = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Sx = Tb.create({
	name: "bold",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
\`\`\``, n;
	...
	addKeyboardShortcuts() {
		return {
			...
			Tab: ({ editor: e }) => {
				...
				let t = this.options.tabSize ?? Ex, { state: n } = e, { selection: r } = n, { $from: i, empty: a } = r;
	...
	addCommands() {
		return { setHorizontalRule: () => ({ chain: e, state: t }) => {
			if (!$b(t, t.schema.nodes[this.name])) return !1;
...
}), Px = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, Fx = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, Ix = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, Lx = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, Rx = Tb.create({
	name: "italic",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
}), zx = "ö", Bx = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Vx = "numeric", Hx = "ascii", Ux = "alpha", Wx = "asciinumeric", Gx = "alphanumeric", Kx = "domain", qx = "emoji", Jx = "scheme", Yx = "slashscheme", Xx = "whitespace";
function Zx(e, t) {
	return e in t || (t[e] = []), t[e];
}
function Qx(e, t, n) {
	t[Vx] && (t[Wx] = !0, t[Gx] = !0), t[Hx] && (t[Wx] = !0, t[Ux] = !0), t[Wx] && (t[Gx] = !0), t[Ux] && (t[Gx] = !0), t[Gx] && (t[Kx] = !0), t[qx] && (t[Kx] = !0);
	for (let r in t) {
		let t = Zx(r, n);
...
eS.groups = {}, eS.prototype = {
	...
	tr(e, t, n, r) {
		r ||= eS.groups;
		let i;
		return t && t.j ? i = t : (i = new eS(t), n && r && Qx(t, n, r)), this.jr.push([e, i]), i;
	},
	ts(e, t, n, r) {
	...
	tt(e, t, n, r) {
		...
		let a = t, o, s = i.go(e);
		return s ? (o = new eS(), Object.assign(o.j, s.j), o.jr.push.apply(o.jr, s.jr), o.jd = s.jd, o.t = s.t) : o = new eS(), a && (r && (o.t && typeof o.t == "string" ? Qx(a, Object.assign($x(o.t, r), n), r) : n && Qx(a, n, r)), o.t = a), i.j[e] = o, o;
	}
};
var X = (e, t, n, r, i) => e.ta(t, n, r, i), Z = (e, t, n, r, i) => e.tr(t, n, r, i), tS = (e, t, n, r, i) => e.ts(t, n, r, i), Q = (e, t, n, r, i) => e.tt(t, n, r, i), nS = "WORD", rS = "UWORD", iS = "ASCIINUMERICAL", aS = "ALPHANUMERICAL", oS = "LOCALHOST", sS = "TLD", cS = "UTLD", lS = "SCHEME", uS = "SLASH_SCHEME", dS = "NUM", fS = "WS", pS = "NL", mS = "OPENBRACE", hS = "CLOSEBRACE", gS = "OPENBRACKET", _S = "CLOSEBRACKET", vS = "OPENPAREN", yS = "CLOSEPAREN", bS = "OPENANGLEBRACKET", xS = "CLOSEANGLEBRACKET", SS = "FULLWIDTHLEFTPAREN", CS = "FULLWIDTHRIGHTPAREN", wS = "LEFTCORNERBRACKET", TS = "RIGHTCORNERBRACKET", ES = "LEFTWHITECORNERBRACKET", DS = "RIGHTWHITECORNERBRACKET", OS = "FULLWIDTHLESSTHAN", kS = "FULLWIDTHGREATERTHAN", AS = "AMPERSAND", jS = "APOSTROPHE", MS = "ASTERISK", NS = "AT", PS = "BACKSLASH", FS = "BACKTICK", IS = "CARET", LS = "COLON", RS = "COMMA", zS = "DOLLAR", BS = "DOT", VS = "EQUALS", HS = "EXCLAMATION", US = "HYPHEN", WS = "PERCENT", GS = "PIPE", KS = "PLUS", qS = "POUND", JS = "QUERY", YS = "QUOTE", XS = "FULLWIDTHMIDDLEDOT", ZS = "SEMI", QS = "SLASH", $S = "TILDE", eC = "UNDERSCORE", tC = "EMOJI", nC = "SYM", rC = /* @__PURE__ */ Object.freeze({
	__proto__: null,
	ALPHANUMERICAL: aS,
	AMPERSAND: AS,
	APOSTROPHE: jS,
	...
	WORD: nS,
	WS: fS
}), iC = /[a-z]/, aC = /\p{L}/u, oC = /\p{Emoji}/u, sC = /\d/, cC = /\s/, lC = "\r", uC = "\n", dC = "️", fC = "‍", pC = "￼", mC = null, hC = null;
function gC(e = []) {
	let t = {};
	eS.groups = t;
	let n = new eS();
	mC ??= bC(zx), hC ??= bC(Bx), Q(n, "'", jS), Q(n, "{", mS), Q(n, "}", hS), Q(n, "[", gS), Q(n, "]", _S), Q(n, "(", vS), Q(n, ")", yS), Q(n, "<", bS), Q(n, ">", xS), Q(n, "（", SS), Q(n, "）", CS), Q(n, "「", wS), Q(n, "」", TS), Q(n, "『", ES), Q(n, "』", DS), Q(n, "＜", OS), Q(n, "＞", kS), Q(n, "&", AS), Q(n, "*", MS), Q(n, "@", NS), Q(n, "`", FS), Q(n, "^", IS), Q(n, ":", LS), Q(n, ",", RS), Q(n, "$", zS), Q(n, ".", BS), Q(n, "=", VS), Q(n, "!", HS), Q(n, "-", US), Q(n, "%", WS), Q(n, "|", GS), Q(n, "+", KS), Q(n, "#", qS), Q(n, "?", JS), Q(n, "\"", YS), Q(n, "/", QS), Q(n, ";", ZS), Q(n, "~", $S), Q(n, "_", eC), Q(n, "\\", PS), Q(n, "・", XS);
	let r = Z(n, sC, dS, { [Vx]: !0 });
	Z(r, sC, r);
	let i = Z(r, iC, iS, { [Wx]: !0 }), a = Z(r, aC, aS, { [Gx]: !0 }), o = Z(n, iC, nS, { [Hx]: !0 });
	Z(o, sC, i), Z(o, iC, o), Z(i, sC, i), Z(i, iC, i);
	let s = Z(n, aC, rS, { [Ux]: !0 });
	Z(s, iC), Z(s, sC, a), Z(s, aC, s), Z(a, sC, a), Z(a, iC), Z(a, aC, a);
	let c = Q(n, uC, pS, { [Xx]: !0 }), l = Q(n, lC, fS, { [Xx]: !0 }), u = Z(n, cC, fS, { [Xx]: !0 });
	Q(n, pC, u), Q(l, uC, c), Q(l, pC, u), Z(l, cC, u), Q(u, lC), Q(u, uC), Z(u, cC, u), Q(u, pC, u);
	let d = Z(n, oC, tC, { [qx]: !0 });
	Q(d, "#"), Z(d, oC, d), Q(d, dC, d);
	let f = Q(d, fC);
	Q(f, "#"), Z(f, oC, d);
	let p = [[iC, o], [sC, i]], m = [
		[iC, null],
	...
	for (let e = 0; e < mC.length; e++) yC(n, mC[e], sS, nS, p);
	for (let e = 0; e < hC.length; e++) yC(n, hC[e], cS, rS, m);
	Qx(sS, {
		tld: !0,
		ascii: !0
	}, t), Qx(cS, {
		utld: !0,
		alpha: !0
	}, t), yC(n, "file", lS, nS, p), yC(n, "mailto", lS, nS, p), yC(n, "http", uS, nS, p), yC(n, "https", uS, nS, p), yC(n, "ftp", uS, nS, p), yC(n, "ftps", uS, nS, p), Qx(lS, {
		scheme: !0,
		ascii: !0
	}, t), Qx(uS, {
		slashscheme: !0,
	...
	for (let t = 0; t < e.length; t++) {
		let r = e[t][0], i = e[t][1] ? { [Jx]: !0 } : { [Yx]: !0 };
		r.indexOf("-") >= 0 ? i[Kx] = !0 : iC.test(r) ? sC.test(r) ? i[Wx] = !0 : i[Hx] = !0 : i[Vx] = !0, tS(n, r, r, i);
	}
	return tS(n, "localhost", oS, { ascii: !0 }), n.jd = new eS(nC), {
		start: n,
		tokens: Object.assign({ groups: t }, rC)
	};
}
function _C(e, t) {
	let n = vC(t.replace(/[A-Z]/g, (e) => e.toLowerCase())), r = n.length, i = [], a = 0, o = 0;
	for (; o < r;) {
...
function yC(e, t, n, r, i) {
	...
	for (let n = 0; n < o - 1; n++) {
		let o = t[n];
		e.j[o] ? a = e.j[o] : (a = new eS(r), a.jr = i.slice(), e.j[o] = a), e = a;
	}
	return a = new eS(n), a.jr = i.slice(), e.j[t[o - 1]] = a, a;
}
function bC(e) {
	let t = [], n = [], r = 0;
	for (; r < e.length;) {
...
function SC(e, t = null) {
	let n = Object.assign({}, xC);
	e && (n = Object.assign(n, e instanceof SC ? e.o : e));
...
SC.prototype = {
	...
	get(e, t, n) {
		...
		return i && (typeof i == "object" ? (i = n.t in i ? i[n.t] : xC[e], typeof i == "function" && r && (i = i(t, n))) : typeof i == "function" && r && (i = i(t, n.t, n)), i);
	},
	getObj(e, t, n) {
		let r = this.o[e];
...
}), DC = TC("text"), OC = TC("nl"), kC = TC("url", {
	isLink: !0,
	toHref(e = xC.defaultProtocol) {
		return this.hasProtocol() ? this.v : `${e}://${this.v}`;
	},
	hasProtocol() {
		let e = this.tk;
		return e.length >= 2 && e[0].t !== oS && e[1].t === LS;
	}
}), AC = (e) => new eS(e);
function jC({ groups: e }) {
	...
	X(f, e.domain, d);
	let p = AC(EC);
	X(f, e.tld, p), X(f, e.utld, p), Q(l, oS, p);
	let m = Q(d, US);
	Q(m, US, m), X(m, e.domain, d), X(p, e.domain, d), Q(p, BS, f), Q(p, US, m), X(Q(p, LS), e.numeric, EC);
	let h = Q(o, US), g = Q(o, BS);
	Q(h, US, h), X(h, e.domain, o), X(g, r, a), X(g, e.domain, o);
	let _ = AC(kC);
	X(g, e.tld, _), X(g, e.utld, _), X(_, e.domain, o), X(_, r, a), Q(_, BS, g), Q(_, US, h), Q(_, NS, l);
	let v = Q(_, LS), y = AC(kC);
	X(v, e.numeric, y);
	let b = AC(kC), x = AC();
	X(b, t, b), X(b, n, x), X(x, t, b), X(x, n, x), Q(_, QS, b), Q(y, QS, b);
	let S = Q(s, LS), C = Q(Q(Q(c, LS), QS), QS);
	X(s, e.domain, o), Q(s, BS, g), Q(s, US, h), X(c, e.domain, o), Q(c, BS, g), Q(c, US, h), X(S, e.domain, b), Q(S, QS, b), Q(S, JS, b), X(C, e.domain, b), X(C, t, b), Q(C, QS, b);
	let w = [
		[mS, hS],
		[gS, _S],
		[vS, yS],
...
function MC(e, t, n) {
	...
	for (; i < r;) {
		...
		if (f < 0) i -= u, i < r && (o.push(n[i]), i++);
			...
			o.length > 0 && (a.push(NC(DC, t, o)), o = []), i -= f, u -= f;
			let e = d.t, r = n.slice(i - u, i);
			a.push(NC(e, t, r));
		}
	}
	return o.length > 0 && a.push(NC(DC, t, o)), a;
}
function NC(e, t, n) {
	let r = n[0].s, i = n[n.length - 1].e;
	return new e(t.slice(r, i), n);
}
var PC = typeof console < "u" && console && console.warn || (() => {}), FC = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", $ = {
	scanner: null,
	parser: null,
	tokenQueue: [],
	pluginQueue: [],
...
function IC() {
	return eS.groups = {}, $.scanner = null, $.parser = null, $.tokenQueue = [], $.pluginQueue = [], $.customSchemes = [], $.initialized = !1, $;
}
function LC(e, t = !1) {
	if ($.initialized && PC(`linkifyjs: already initialized - will not register custom scheme "${e}" ${FC}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(e)) throw Error("linkifyjs: incorrect scheme format.\n1. Must only contain digits, lowercase ASCII letters or \"-\"\n2. Cannot start or end with \"-\"\n3. \"-\" cannot repeat");
	$.customSchemes.push([e, t]);
}
function RC() {
	$.scanner = gC($.customSchemes);
	for (let e = 0; e < $.tokenQueue.length; e++) $.tokenQueue[e][1]({ scanner: $.scanner });
	$.parser = jC($.scanner.tokens);
...
function zC(e) {
	return $.initialized || RC(), MC($.parser.start, e, _C($.scanner.start, e));
}
zC.scan = _C;
...
var VC = "[\0- \xA0 ᠎ -\u2029 　]", HC = new RegExp(VC), UC = RegExp(`${VC}$`), WC = new RegExp(VC, "g");
function GC(e) {
	...
	return new K({
		...
		appendTransaction: (t, n, r) => {
			...
			if (Oy(Qv(n.doc, [...t])).forEach(({ newRange: t }) => {
				...
				if (i && a) {
					let t = a.split(HC).filter(Boolean);
					if (t.length <= 0) return !1;
					let n = t[t.length - 1], s = i.pos + a.lastIndexOf(n);
					if (!n) return !1;
					let c = zC(n).map((t) => t.toObject(e.defaultProtocol));
					if (!GC(c)) return !1;
...
function JC(e) {
	return new K({
		...
		props: { handlePaste: (t, n, r) => {
			...
			let l = BC(c, { defaultProtocol: e.defaultProtocol }).find((e) => e.isLink && e.value === c);
...
function YC(e, t) {
	...
	return t && t.forEach((e) => {
		...
		t && n.push(t);
	}), !e || e.replace(WC, "").match(RegExp(`^(?:(?:${n.join("|")}):|[^a-z]|[a-z0-9+.-]+(?:[^a-z+.-:]|$))`, "i"));
}
var XC = Tb.create({
	name: "link",
	priority: 1e3,
	...
	addOptions() {
		return {
			...
			isAllowedUri: (e, t) => !!YC(e, t.protocols),
			validate: (e) => !!e,
			shouldAutoLink: (e) => {
		...
		return [{
			...
			getAttrs: (e) => {
				...
				return !t || !this.options.isAllowedUri(t, {
					defaultValidate: (e) => !!YC(e, this.options.protocols),
	...
	addPasteRules() {
		return [dx({
			find: (e) => {
				let t = [];
				if (e) {
					let { protocols: n, defaultProtocol: r } = this.options, i = BC(e).filter((e) => e.isLink && this.options.isAllowedUri(e.value, {
						defaultValidate: (e) => !!YC(e, n),
						protocols: n,
						defaultProtocol: r
					}));
	...
	addProseMirrorPlugins() {
		...
		return this.options.autolink && e.push(KC({
			type: this.type,
			defaultProtocol: this.options.defaultProtocol,
			validate: (e) => this.options.isAllowedUri(e, {
				defaultValidate: (e) => !!YC(e, t),
				protocols: t,
				defaultProtocol: n
			}),
		...
		})), this.options.linkOnPaste && e.push(JC({
			editor: this.editor,
			defaultProtocol: this.options.defaultProtocol,
			type: this.type,
			shouldAutoLink: this.options.shouldAutoLink
...
}), ZC = XC, QC = Object.defineProperty, $C = (e, t) => {
	for (var n in t) QC(e, n, {
		get: t[n],
		enumerable: !0
	});
}, ew = "listItem", tw = "textStyle", nw = /^\s*([-+*])\s$/, rw = ux.create({
	name: "bulletList",
	addOptions() {
		return {
	...
	addCommands() {
		return { toggleBulletList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(ew, this.editor.getAttributes(tw)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
	...
	addInputRules() {
		...
		return (this.options.keepMarks || this.options.keepAttributes) && (e = Qb({
			...
			getAttributes: () => this.editor.getAttributes(tw),
			editor: this.editor
		})), [e];
	}
}), iw = ux.create({
	...
	renderMarkdown: (e, t, n) => cx(e, t, (e) => e.parentType === "bulletList" ? "- " : e.parentType === "orderedList" ? `${(e.meta?.parentAttrs?.start || 1) + e.index}. ` : "- ", n),
	addKeyboardShortcuts() {
		return {
...
$C({}, {
	...
	hasListBefore: () => sw,
	hasListItemAfter: () => mw,
	hasListItemBefore: () => cw,
	listItemHasSubList: () => lw,
	nextListIsDeeper: () => dw,
	nextListIsHigher: () => fw
});
var aw = (e, t) => {
	...
	if (!Pv(e.state, t) && sw(e.state, t, n)) {
	...
	let r = aw(t, e.state);
	if (!r) return !1;
	let i = e.state.doc.resolve(r.$pos.pos - 2).node(r.depth), a = lw(t, e.state, i);
	return cw(t, e.state) && !a ? e.commands.joinItemBackward() : e.chain().liftListItem(t).run();
}, dw = (e, t) => {
	let n = ow(e, t), r = aw(e, t);
	...
	return !n.empty && r.sameParent(i) ? !1 : dw(t, e.state) ? e.chain().focus(e.state.selection.from + 4).lift(t).joinBackward().run() : fw(t, e.state) ? e.chain().joinForward().joinBackward().run() : e.commands.joinItemForward();
}, mw = (e, t) => {
		...
		return {
			Delete: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n }) => {
					e.state.schema.nodes[n] !== void 0 && pw(e, n) && (t = !0);
				}), t;
			},
			"Mod-Delete": ({ editor: e }) => {
				let t = !1;
			...
			Backspace: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
					e.state.schema.nodes[n] !== void 0 && uw(e, n, r) && (t = !0);
				}), t;
			},
...
function bw(e) {
	...
	for (; n < e.length;) {
		...
		for (; d < e.length;) {
			...
			else if (t.match(_w)) f.push(t), u.push(t.slice(l + 2)), d += 1;
			else {
				if (p) break;
...
function xw(e, t, n) {
	...
	for (; i < e.length;) {
		let a = e[i];
		if (a.indent === t) {
			let { paragraphLines: o, blockLines: s } = yw(a.contentLines), c = o.join("\n").trim(), l = [];
			c && l.push({
				type: "paragraph",
				raw: c,
			...
			if (f.length > 0) {
				let e = xw(f, Math.min(...f.map((e) => e.indent)), n);
				l.push({
					type: "list",
					ordered: !0,
					start: f[0].number,
...
var Cw = "listItem", ww = "textStyle", Tw = /^(\d+)\.\s$/, Ew = ux.create({
	name: "orderedList",
	addOptions() {
		return {
			itemTypeName: "listItem",
	...
	parseMarkdown: (e, t) => {
		...
		let n = e.start || 1, r = e.items ? Sw(e.items, t) : [];
		return n === 1 ? {
			type: "orderedList",
			content: r
		} : {
	...
	markdownOptions: { indentsContent: !0 },
	addCommands() {
		return { toggleOrderedList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Cw, this.editor.getAttributes(ww)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
	...
	addInputRules() {
		...
		return (this.options.keepMarks || this.options.keepAttributes) && (e = Qb({
			...
			getAttributes: (e) => ({
				start: +e[1],
				...this.editor.getAttributes(ww)
			}),
			joinPredicate: (e, t) => t.childCount + t.attrs.start === +e[1],
			editor: this.editor
		})), [e];
	}
}), Dw = /^\s*(\[([( |x])?\])\s$/, Ow = ux.create({
	name: "taskItem",
	addOptions() {
		return {
			nested: !1,
	...
	renderMarkdown: (e, t) => cx(e, t, `- [${e.attrs?.checked ? "x" : " "}] `),
	addKeyboardShortcuts() {
		let e = {
			Enter: () => this.editor.commands.splitListItem(this.name),
			"Shift-Tab": () => this.editor.commands.liftListItem(this.name)
...
Y.create({
	...
	addExtensions() {
		let e = [];
		return this.options.bulletList !== !1 && e.push(rw.configure(this.options.bulletList)), this.options.listItem !== !1 && e.push(iw.configure(this.options.listItem)), this.options.listKeymap !== !1 && e.push(hw.configure(this.options.listKeymap)), this.options.orderedList !== !1 && e.push(Ew.configure(this.options.orderedList)), this.options.taskItem !== !1 && e.push(Ow.configure(this.options.taskItem)), this.options.taskList !== !1 && e.push(kw.configure(this.options.taskList)), e;
	}
});
//#endregion
//#region node_modules/@tiptap/extension-paragraph/dist/index.js
var Aw = "&nbsp;", jw = "\xA0", Mw = ux.create({
	name: "paragraph",
	priority: 1e3,
	addOptions() {
		return { HTMLAttributes: {} };
	...
	parseMarkdown: (e, t) => {
		...
		return n.length === 1 && n[0].type === "text" && (n[0].raw === Aw || n[0].text === Aw || n[0].raw === jw || n[0].text === jw) && r.length === 1 && r[0].type === "text" && (r[0].text === Aw || r[0].text === jw) ? t.createNode("paragraph", void 0, []) : t.createNode("paragraph", void 0, r);
	},
	renderMarkdown: (e, t, n) => {
		...
		if (r.length === 0) {
			...
			return n?.previousNode?.type === "paragraph" && e.length === 0 ? Aw : "";
		}
...
}), Nw = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, Pw = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, Fw = Tb.create({
	name: "strike",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
var Bw = class {
	...
	getBookmark() {
		return new Hw(this.anchor);
	}
	static valid(e) {
		let t = e.parent;
		if (t.inlineContent || !Ww(e) || !Gw(e)) return !1;
...
Vw.prototype.visible = !1, Vw.findFrom = Vw.findGapCursorFrom, U.jsonID("gapcursor", Vw);
var Hw = class e {
	constructor(e) {
		this.pos = e;
	}
	...
	resolve(e) {
		...
		return Vw.valid(t) ? new Vw(t) : U.near(t);
	}
};
function Uw(e) {
...
function Ww(e) {
	for (let t = e.depth; t >= 0; t--) {
		...
		for (let e = r.child(n - 1);; e = e.lastChild) {
			if (e.childCount == 0 && !e.inlineContent || Uw(e.type)) return !0;
...
function Kw() {
	return new K({ props: {
		...
		createSelectionBetween(e, t, n) {
			return t.pos == n.pos && Vw.valid(n) ? new Vw(n) : null;
		},
		handleClick: Yw,
		handleKeyDown: qw,
		handleDOMEvents: { beforeinput: Xw }
	} });
}
var qw = F_({
	ArrowLeft: Jw("horiz", -1),
	ArrowRight: Jw("horiz", 1),
	ArrowUp: Jw("vert", -1),
	ArrowDown: Jw("vert", 1)
});
function Jw(e, t) {
	...
	return function(e, r, i) {
		...
		let c = Vw.findGapCursorFrom(o, t, s);
		return c ? (r && r(e.tr.setSelection(new Vw(c))), !0) : !1;
	};
}
function Yw(e, t, n) {
	if (!e || !e.editable) return !1;
	let r = e.state.doc.resolve(t);
	if (!Vw.valid(r)) return !1;
	let i = e.posAtCoords({
		left: n.clientX,
		top: n.clientY
	});
	return i && i.inside > -1 && G.isSelectable(e.state.doc.nodeAt(i.inside)) ? !1 : (e.dispatch(e.state.tr.setSelection(new Vw(r))), !0);
}
function Xw(e, t) {
	if (t.inputType != "insertCompositionText" || !(e.state.selection instanceof Vw)) return !1;
...
function Zw(e) {
	if (!(e.selection instanceof Vw)) return null;
...
var Qw = 200, $w = function() {};
$w.prototype.append = function(e) {
	return e.length ? (e = $w.from(e), !this.length && e || e.length < Qw && this.leafAppend(e) || this.length < Qw && e.leafPrepend(this) || this.appendInner(e)) : this;
	...
	return e instanceof $w ? e : e && e.length ? new eT(e) : $w.empty;
};
var eT = /* @__PURE__ */ function(e) {
	...
	return t.prototype.flatten = function() {
		...
		if (this.length + e.length <= Qw) return new t(this.values.concat(e.flatten()));
	}, t.prototype.leafPrepend = function(e) {
		if (this.length + e.length <= Qw) return new t(e.flatten().concat(this.values));
...
var tT = /* @__PURE__ */ function(e) {
	...
	popEvent(t, n) {
		...
		return this.items.forEach((t, n) => {
			...
			if (i) {
				...
				e && o.maybeStep(e).doc && (n = o.mapping.maps[o.mapping.maps.length - 1], l.push(new aT(n, void 0, void 0, l.length + u.length))), a--, n && i.appendMap(n, a);
	...
	addTransform(t, n, r, i) {
		...
		for (let e = 0; e < t.steps.length; e++) {
			let r = t.steps[e].invert(t.docs[e]), l = new aT(t.mapping.maps[e], r, n), u;
			(u = c && c.merge(l)) && (l = u, e ? a.pop() : s = s.slice(0, s.length - 1)), a.push(l), n &&= (o++, void 0), i || (c = l);
		}
		let l = o - r.depth;
		return l > sT && (s = iT(s, l), o -= l), new e(s.append(a), o);
	}
	remapping(e, t) {
		let n = new Lu();
	...
	addMaps(t) {
		return this.eventCount == 0 ? this : new e(this.items.append(t.map((e) => new aT(e))), this.eventCount);
	}
	rebased(t, n) {
		...
		this.items.forEach((e) => {
			...
			if (e.step) {
				...
				l && s++, r.push(new aT(i, o, l));
			} else r.push(new aT(i));
		}, i);
		let l = [];
		for (let e = n; e < o; e++) l.push(new aT(a.maps[e]));
		let u = new e(this.items.slice(0, i).append(l).append(r), s);
		return u.emptyItemCount() > nT && (u = u.compress(this.items.length - r.length)), u;
	}
	emptyItemCount() {
		let e = 0;
		...
		return this.items.forEach((e, o) => {
			if (o >= t) i.push(e), e.selection && a++;
				...
				if (r--, o && n.appendMap(o, r), t) {
					...
					s && a++;
					let c = new aT(o.invert(), t, s), l, u = i.length - 1;
...
function cT(e, t, n, r) {
	let i = n.getMeta(gT), a;
	if (i) return i.historyState;
	n.getMeta(_T) && (e = new oT(e.done, e.undone, null, 0, -1));
	let o = n.getMeta("appendedTransaction");
	if (n.steps.length == 0) return e;
	if (o && o.getMeta(gT)) return o.getMeta(gT).redo ? new oT(e.done.addTransform(n, void 0, r, hT(t)), e.undone, uT(n.mapping.maps), e.prevTime, e.prevComposition) : new oT(e.done, e.undone.addTransform(n, void 0, r, hT(t)), null, e.prevTime, e.prevComposition);
	if (n.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
		let i = n.getMeta("composition"), a = e.prevTime == 0 || !o && e.prevComposition != i && (e.prevTime < (n.time || 0) - r.newGroupDelay || !lT(n, e.prevRanges)), s = o ? dT(e.prevRanges, n.mapping) : uT(n.mapping.maps);
		return new oT(e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, hT(t)), rT.empty, s, n.time, i ?? e.prevComposition);
	} else if (a = n.getMeta("rebased")) return new oT(e.done.rebased(n, a), e.undone.rebased(n, a), dT(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
	else return new oT(e.done.addMaps(n.mapping.maps), e.undone.addMaps(n.mapping.maps), dT(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
}
function lT(e, t) {
	if (!t) return !1;
...
function fT(e, t, n) {
	let r = hT(t), i = gT.get(t).spec.config, a = (n ? e.undone : e.done).popEvent(t, r);
	if (!a) return null;
	let o = a.selection.resolve(a.transform.doc), s = (n ? e.done : e.undone).addTransform(a.transform, t.selection.getBookmark(), i, r), c = new oT(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
	return a.transform.setSelection(o).setMeta(gT, {
		redo: n,
		historyState: c
	});
}
...
var gT = new cf("history"), _T = new cf("closeHistory");
function vT(e = {}) {
	return e = {
		depth: e.depth || 100,
		...
		state: {
			init() {
				return new oT(rT.empty, rT.empty, null, 0, -1);
			},
			apply(t, n, r) {
				return cT(n, r, t, e);
			}
		...
		props: { handleDOMEvents: { beforeinput(e, t) {
			let n = t.inputType, r = n == "historyUndo" ? bT : n == "historyRedo" ? xT : null;
...
var ET = Y.create({
	...
	addProseMirrorPlugins() {
		let e = this.options.dataAttribute ? `data-${TT(this.options.dataAttribute)}` : `data-${wT}`;
		return [new K({
...
var OT = Y.create({
	...
	addCommands() {
		return {
			undo: () => ({ state: e, dispatch: t }) => bT(e, t),
			redo: () => ({ state: e, dispatch: t }) => xT(e, t)
		};
	},
	addProseMirrorPlugins() {
	...
	addExtensions() {
		let e = [];
		return this.options.bold !== !1 && e.push(Sx.configure(this.options.bold)), this.options.blockquote !== !1 && e.push(_x.configure(this.options.blockquote)), this.options.bulletList !== !1 && e.push(rw.configure(this.options.bulletList)), this.options.code !== !1 && e.push(Tx.configure(this.options.code)), this.options.codeBlock !== !1 && e.push(kx.configure(this.options.codeBlock)), this.options.document !== !1 && e.push(Ax.configure(this.options.document)), this.options.dropcursor !== !1 && e.push(ST.configure(this.options.dropcursor)), this.options.gapcursor !== !1 && e.push(CT.configure(this.options.gapcursor)), this.options.hardBreak !== !1 && e.push(jx.configure(this.options.hardBreak)), this.options.heading !== !1 && e.push(Mx.configure(this.options.heading)), this.options.undoRedo !== !1 && e.push(kT.configure(this.options.undoRedo)), this.options.horizontalRule !== !1 && e.push(Nx.configure(this.options.horizontalRule)), this.options.italic !== !1 && e.push(Rx.configure(this.options.italic)), this.options.listItem !== !1 && e.push(iw.configure(this.options.listItem)), this.options.listKeymap !== !1 && e.push(hw.configure(this.options?.listKeymap)), this.options.link !== !1 && e.push(XC.configure(this.options?.link)), this.options.orderedList !== !1 && e.push(Ew.configure(this.options.orderedList)), this.options.paragraph !== !1 && e.push(Mw.configure(this.options.paragraph)), this.options.strike !== !1 && e.push(Fw.configure(this.options.strike)), this.options.text !== !1 && e.push(Iw.configure(this.options.text)), this.options.underline !== !1 && e.push(Lw.configure(this.options?.underline)), this.options.trailingNode !== !1 && e.push(OT.configure(this.options?.trailingNode)), e;
	}
}), jT = Y.create({
	name: "textAlign",
	addOptions() {
...
var FT = {
	...
	watch: {
		modelValue(e) {
			...
			let t = (e || "").trim();
			t !== PT(this.editor.getHTML()) && this.editor.commands.setContent(t || "<p></p>", !1);
		},
		placeholderText() {
			this.recreateEditor();
		}
	...
	methods: {
		createEditor(e) {
			...
			this.placeholderText && n.push(MT.configure({
		...
		recreateEditor() {
			...
			this.editor?.destroy(), this.editor = null, this.$nextTick(() => {
				this.createEditor(PT(e));
			});
		},
		toggleLink() {
			if (!this.editor) return;
			let e = this.editor.getAttributes("link").href, t = window.prompt("Link URL:", e || "https://");
			if (t !== null) {
				if (t === "") {
	...
	role: "toolbar"
}, LT = { class: "btn-group btn-group-sm" }, RT = { class: "btn-group btn-group-sm" }, zT = { class: "btn-group btn-group-sm" }, BT = { class: "btn-group btn-group-sm" }, VT = { class: "btn-group btn-group-sm" }, HT = { class: "btn-group btn-group-sm" };
function UT(e, a, o, s, c, l) {
	let u = y("editor-content");
	return g(), r("div", { class: p(["tiptap-html-editor", [e.$attrs.class]]) }, [e.editor ? (g(), r("div", IT, [
		i("span", LT, [
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("bold") }]),
				title: "Félkövér",
				onClick: a[0] ||= (t) => e.editor.chain().focus().toggleBold().run()
			}, "B", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("italic") }]),
				title: "Dőlt",
				onClick: a[1] ||= (t) => e.editor.chain().focus().toggleItalic().run()
			}, [...a[18] ||= [i("i", null, "I", -1)]], 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("underline") }]),
				title: "Aláhúzott",
				onClick: a[2] ||= (t) => e.editor.chain().focus().toggleUnderline().run()
			}, [...a[19] ||= [i("u", null, "U", -1)]], 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("strike") }]),
				title: "Áthúzott",
				onClick: a[3] ||= (t) => e.editor.chain().focus().toggleStrike().run()
			}, [...a[20] ||= [i("s", null, "S", -1)]], 2)
		]),
		i("span", RT, [
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("heading", { level: 1 }) }]),
				onClick: a[4] ||= (t) => e.editor.chain().focus().toggleHeading({ level: 1 }).run()
			}, "H1", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("heading", { level: 2 }) }]),
				onClick: a[5] ||= (t) => e.editor.chain().focus().toggleHeading({ level: 2 }).run()
			}, "H2", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("heading", { level: 3 }) }]),
				onClick: a[6] ||= (t) => e.editor.chain().focus().toggleHeading({ level: 3 }).run()
			}, "H3", 2)
		]),
		i("span", zT, [
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("bulletList") }]),
				title: "Lista",
				onClick: a[7] ||= (t) => e.editor.chain().focus().toggleBulletList().run()
			}, "•", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("orderedList") }]),
				title: "Számozott",
				onClick: a[8] ||= (t) => e.editor.chain().focus().toggleOrderedList().run()
			}, "1.", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive("blockquote") }]),
				title: "Idézet",
				onClick: a[9] ||= (t) => e.editor.chain().focus().toggleBlockquote().run()
			}, "”", 2)
		]),
		i("span", BT, [
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive({ textAlign: "left" }) }]),
				onClick: a[10] ||= (t) => e.editor.chain().focus().setTextAlign("left").run()
			}, "←", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive({ textAlign: "center" }) }]),
				onClick: a[11] ||= (t) => e.editor.chain().focus().setTextAlign("center").run()
			}, "↔", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive({ textAlign: "right" }) }]),
				onClick: a[12] ||= (t) => e.editor.chain().focus().setTextAlign("right").run()
			}, "→", 2),
			i("button", {
				type: "button",
				class: p(["btn btn-outline-secondary", { active: e.editor.isActive({ textAlign: "justify" }) }]),
				onClick: a[13] ||= (t) => e.editor.chain().focus().setTextAlign("justify").run()
			}, "≡", 2)
		]),
		i("span", VT, [i("button", {
			type: "button",
			...
			title: "Link",
			onClick: a[14] ||= (...t) => e.toggleLink && e.toggleLink(...t)
		}, "🔗"), i("button", {
			type: "button",
			class: "btn btn-outline-secondary",
			title: "Link törlése",
			onClick: a[15] ||= (t) => e.editor.chain().focus().unsetLink().run()
		}, "✕")]),
		i("span", HT, [i("button", {
			type: "button",
			class: "btn btn-outline-secondary",
			title: "Visszavonás",
			onClick: a[16] ||= (t) => e.editor.chain().focus().undo().run()
		}, "↶"), i("button", {
			type: "button",
			class: "btn btn-outline-secondary",
			title: "Újra",
			onClick: a[17] ||= (t) => e.editor.chain().focus().redo().run()
		}, "↷")])
	])) : n("", !0), e.editor ? (g(), t(u, {
		key: 1,
		editor: e.editor,
...
var WT = /* @__PURE__ */ NT(FT, [["render", UT]]), GT = {
	props: { file: Object },
	methods: {
		roundFileSize(e, t) {
			let n = 1024, r = n * 1024, i = r * 1024;
...
}, qT = { class: "text-nowrap text-center" }, JT = { class: "text-center" }, YT = { class: "text-nowrap text-end" }, XT = ["innerHTML"], ZT = { class: "text-end" }, QT = { class: "text-nowrap text-center" }, $T = { class: "text-center" }, eE = { class: "text-end" }, tE = ["innerHTML"], nE = { class: "text-end" }, rE = {
	key: 0,
	class: "fw-normal bg-light text-dark p-0 px-1 shadow-sm"
}, iE = { colspan: "3" }, aE = { class: "text-end" }, oE = ["innerHTML"], sE = { class: "d-flex justify-content-between text-nowrap" }, cE = { class: "d-flex justify-content-between text-nowrap" }, lE = { class: "text-muted fw-light me-3" }, uE = {
	key: 1,
	class: "d-flex justify-content-between"
};
function dE(t, o, s, c, l, u) {
	return g(), r("div", null, [
		t.file ? (g(), r("table", KT, [
			...
			i("tbody", null, [i("tr", null, [
				...
				i("td", qT, b(t.file.original.width) + " x " + b(t.file.original.height), 1),
				i("td", JT, b(t.file.original.ratio), 1),
				i("td", YT, [i("span", { innerHTML: t.roundFileSize(t.file.original.bytes, !0) }, null, 8, XT)]),
				i("td", ZT, b(t.file.original.extension), 1),
				o[1] ||= i("td", null, null, -1)
			]), (g(!0), r(e, null, v(t.file.types, (e, a) => (g(), r("tr", { key: e }, [
				i("td", null, b(a), 1),
				i("td", QT, b(e.width) + " x " + b(e.height), 1),
				i("td", $T, b(e.ratio), 1),
				i("td", eE, [i("span", {
					class: p(["text-nowrap", { "text-danger": e.bytes > t.file.original.bytes }]),
					innerHTML: t.roundFileSize(e.bytes, !0)
				}, null, 10, tE)]),
				i("td", nE, b(e.extension), 1),
				i("td", null, [e.crop ? (g(), r("small", rE, b(e.crop), 1)) : n("", !0)])
			]))), 128))]),
			i("tfoot", null, [i("tr", null, [
				i("td", iE, b(t.file.uploaded ? "uploaded" : "uploading"), 1),
				i("td", aE, [i("span", {
					class: "text-nowrap",
		...
		i("small", sE, [o[4] ||= i("span", { class: "text-muted fw-light me-3" }, "original filename", -1), a(" " + b(t.file.original.name), 1)]),
		i("small", cE, [
			i("span", lE, b(t.file.uploaded ? "uploaded" : "uploading") + " filename", 1),
			o[5] ||= a(),
			i("span", null, b(t.file.slug), 1)
		]),
		t.file.uploaded ? (g(), r("small", uE, [
...
var fE = /* @__PURE__ */ NT(GT, [["render", dE]]), pE = {
	image: {
		jpg: "image/jpeg",
		jpeg: "image/jpeg",
		png: "image/png",
	...
	components: { VuAdminFileUploadInfo: fE },
	created() {
		let e = Rc(1e5);
	...
	methods: {
		...
		getAcceptMimeTypes(e) {
			let t = [];
			for (let n in pE) if (pE.hasOwnProperty(n)) {
				let r = pE[n];
				e.forEach((e) => {
					r[e] && t.push(r[e]);
				});
		...
		detect(e) {
			...
			}, Object.values(pE.video).indexOf(e.original.mime) >= 0 ? e.isVideo = !0 : Object.values(pE.image).indexOf(e.original.mime) >= 0 ? e.isImage = !0 : Object.values(pE.document).indexOf(e.original.mime) >= 0 ? e.isDocument = !0 : e.isUnknown = !0, (e.isVideo || e.isImage && !this.params.presets.default) && (this.params.presets.default = {
				width: 1920,
				height: 1920,
				extension: "webp",
				quality: .9
		...
		getMimeTypeByExtension(e) {
			for (let t in pE) if (pE.hasOwnProperty(t)) {
				let n = pE[t];
				if (n[e]) return n[e];
			}
			return null;
...
}, _E = { class: "row" }, vE = { class: "badge bg-dark text-light fw-light mx-1 text-uppercase" }, yE = { class: "badge bg-dark text-light fw-light mx-1" }, bE = { class: "badge bg-dark text-light fw-light mx-1" }, xE = ["src"], SE = { class: "row g-1" }, CE = { class: "col-md-6" }, wE = { class: "col-md-6" }, TE = { class: "col-md-6" }, EE = ["href"], DE = {
	key: 1,
	class: "row g-2 mb-1"
}, OE = { key: 0 }, kE = { class: "table table-sm table-responsive table-borderless" }, AE = { class: "align-middle px-0" }, jE = { class: "input-group border" }, ME = { class: "d-block p-1 px-2" }, NE = ["onClick"], PE = ["onClick"], FE = {
	key: 0,
	class: "fs-5 mx-2"
}, IE = {
	key: 1,
	...
	key: 2,
	class: "fs-5 mx-2"
}, RE = ["onUpdate:modelValue", "onInput"], zE = {
	key: 3,
	class: "mx-0"
}, BE = ["href"], VE = ["src", "alt"], HE = ["src", "alt"], UE = {
	key: 4,
	...
	"aria-expanded": "false"
}, GE = { class: "dropdown-menu" }, KE = ["onClick"], qE = {
	key: 0,
	class: "bi bi-check-square"
}, JE = {
	key: 1,
	class: "bi bi-square"
}, YE = ["onClick"], XE = ["onClick"], ZE = ["onClick"], QE = { class: "dropdown" }, $E = { class: "dropdown-menu" }, eD = { class: "p-2" }, tD = { class: "fw-light" }, nD = ["onClick"], rD = { class: "vsa-image-container h-100 position-relative" }, iD = {
	key: 0,
...
}, oD = ["href"], sD = ["src", "alt"], cD = ["src", "alt"], lD = {
	key: 2,
	class: "display-3 w-100 h-100 text-center mb-auto d-flex align-items-center justify-content-center"
}, uD = ["onUpdate:modelValue", "onInput"], dD = { class: "w-100 mb-2 d-flex justify-content-around align-items-center" }, fD = { class: "p-1 px-2 border border-end-0 h-100" }, pD = ["onClick"], mD = ["onClick"], hD = {
	key: 0,
	...
	"data-bs-toggle": "dropdown",
	"aria-expanded": "false"
}, _D = { class: "dropdown-menu" }, vD = ["onClick"], yD = {
	key: 0,
	class: "bi bi-check-square"
}, bD = {
	key: 1,
	class: "bi bi-square"
}, xD = ["onClick"], SD = ["onClick"], CD = ["onClick"], wD = { class: "dropdown border h-100 w-100" }, TD = { class: "dropdown-menu" }, ED = { class: "p-2" }, DD = { class: "fw-light" }, OD = ["onClick"], kD = {
	key: 1,
	class: "w-100 h-100 vsa-image-loading d-flex align-items-center justify-content-center"
}, AD = { class: "row g-1" }, jD = { class: "col-12 d-flex align-items-center justify-content-center" }, MD = ["for"], ND = { key: 0 }, PD = { key: 0 }, FD = { class: "" }, ID = { class: "" }, LD = {
	key: 1,
	class: "fs-6"
}, RD = {
	key: 0,
	...
	key: 1,
	class: "bi bi-grid"
}, BD = ["disabled"], VD = { class: "col-12 text-center" }, HD = { key: 0 }, UD = ["id", "accept"];
function WD(t, s, c, l, u, d) {
	let f = y("VuAdminFileUploadInfo");
	return g(), r("div", hE, [i("div", { class: p(["vsa-upload", { wait: t.wait }]) }, [
		t.editfile && t.editfile.presets ? (g(), r("div", gE, [
			i("div", _E, [(g(!0), r(e, null, v(t.editfile.types, (e, a) => (g(), r("div", {
				class: "col-md-3",
				key: a
			}, [
				i("span", vE, b(e.extension), 1),
				i("span", yE, b(e.width) + " x " + b(e.height), 1),
				i("span", bE, "~" + b(t.roundFileSize(e.bytes)), 1),
				e ? (g(), r("img", {
					key: 0,
			...
			i("div", SE, [
				...
				i("div", TE, [t.type && !t.type.url ? (g(), r("button", {
					key: 0,
					type: "button",
		...
		t.files && t.files.length ? (g(), r("div", DE, [t.params.ui === "list" ? (g(), r("div", OE, [i("table", kE, [i("tbody", null, [(g(!0), r(e, null, v(t.files, (c, l) => (g(), r("tr", { key: l }, [i("td", AE, [i("div", jE, [
			i("span", ME, b(l + 1), 1),
			i("span", {
				class: "cursor-pointer p-1 border-start border-end h-100",
				onClick: (e) => t.arrayItemMoveDown(t.files, l)
			}, [i("i", { class: p(["bi bi-arrow-up", { "opacity-25": l < 1 }]) }, null, 2)], 8, NE),
			i("span", {
				class: "cursor-pointer p-1 border-start border-end h-100",
				onClick: (e) => t.arrayItemMoveUp(t.files, l + 1)
			}, [i("i", { class: p(["bi bi-arrow-down", { "opacity-25": l >= t.files.length - 1 }]) }, null, 2)], 8, PE),
			c.isDocument ? (g(), r("span", FE, [i("i", { class: p(["bi bi-filetype-" + c.types.default.extension]) }, null, 2)])) : c.isImage ? (g(), r("span", IE, [...s[12] ||= [i("i", { class: "bi bi-file-image" }, null, -1)]])) : c.isVideo ? (g(), r("span", LE, [...s[13] ||= [i("i", { class: "bi bi-file-play" }, null, -1)]])) : n("", !0),
			D(i("input", {
				required: "text",
			...
			}, null, 40, RE), [[T, c.title]]),
			!c.isDocument && c.types && c.types[t.params.thumbnail] ? (g(), r("span", zE, [c.types.default.url ? (g(), r("a", {
				key: 0,
				target: "_blank",
			...
			i("button", {
				...
				type: "button"
			}, [...s[17] ||= [i("i", { class: "bi bi-x-circle" }, null, -1)]], 8, nD)
			...
			key: l
		}, [i("div", rD, [c.loaded ? (g(), r("div", iD, [
			n("", !0),
			c.types && c.types[t.params.thumbnail] ? (g(), r("div", aD, [c.types.default.url ? (g(), r("a", {
				key: 0,
				target: "_blank",
				href: c.types.default.url
			}, [i("img", {
				...
				src: c.types[t.params.thumbnail].url,
				alt: c.name
			}, null, 8, sD)], 8, oD)) : (g(), r("img", {
				key: 1,
				class: "img-fluid transparent-background",
				src: c.types[t.params.thumbnail].data,
				alt: c.name
			}, null, 8, cD))])) : n("", !0),
			c.isDocument ? (g(), r("div", lD, [i("i", { class: p(["bi bi-filetype-" + c.types.default.extension]) }, null, 2)])) : n("", !0),
			D(i("input", {
				required: "text",
			...
			}, null, 40, uD), [[T, c.title]]),
			i("div", dD, [
				i("span", fD, b(l + 1), 1),
				i("span", {
					class: "cursor-pointer p-1 border border-end-0 h-100",
					onClick: (e) => t.arrayItemMoveDown(t.files, l)
				}, [i("i", { class: p(["bi bi-arrow-up", { "opacity-25": l < 1 }]) }, null, 2)], 8, pD),
				i("span", {
					class: "cursor-pointer p-1 border border-end-0 h-100",
					onClick: (e) => t.arrayItemMoveUp(t.files, l + 1)
				}, [i("i", { class: p(["bi bi-arrow-down", { "opacity-25": l >= t.files.length - 1 }]) }, null, 2)], 8, mD),
				t.params.tags ? (g(), r("div", hD, [i("button", gD, [s[21] ||= i("i", { class: "bi bi-tag" }, null, -1), a(" " + b(c.tags ? c.tags.length : 0), 1)]), i("ul", _D, [
					i("li", null, [(g(!0), r(e, null, v(t.params.tags, (e) => (g(), r("span", {
						key: e,
						class: "dropdown-item cursor-pointer",
						onClick: (n) => t.dropdownSelectToggleOne(c.tags, e.value)
					}, [c.tags && c.tags.indexOf(e.value) >= 0 ? (g(), r("i", yD)) : (g(), r("i", bD)), a(" " + b(t.translate(e.label ? e.label : e.value)), 1)], 8, vD))), 128))]),
					s[22] ||= i("li", null, [i("hr", { class: "dropdown-divider" })], -1),
					i("li", null, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => t.dropdownSelectAll(c.tags, t.params.tags)
					}, b(t.translate("Select all")), 9, xD)]),
					i("li", null, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => t.dropdownSelectClear(c.tags)
					}, b(t.translate("Unselect all")), 9, SD)]),
					i("li", null, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => t.dropdownSelectInvert(c.tags, t.params.tags)
					}, b(t.translate("Invert all")), 9, CD)])
				])])) : n("", !0),
				i("div", wD, [s[23] ||= i("button", {
					class: "btn btn-sm rounded-0 h-100 _dropdown-toggle w-100",
					type: "button",
					"data-bs-toggle": "dropdown",
					"aria-expanded": "false"
				}, [i("i", { class: "bi bi-list" })], -1), i("ul", TD, [i("li", ED, [i("small", DD, [o(f, { file: c }, null, 8, ["file"])])])])]),
				i("button", {
					class: "btn btn-outline-danger border rounded-0 border-start-0 px-2 py-1",
					onClick: (e) => t.remove(l),
					type: "button"
				}, [...s[24] ||= [i("i", { class: "bi bi-x-circle" }, null, -1)]], 8, OD)
			])
		])) : (g(), r("div", kD, [...s[25] ||= [i("span", null, null, -1)]]))])], 2))), 128))])) : n("", !0),
		i("div", AD, [i("div", jD, [
			i("label", {
				for: t.uploadId,
				class: p([
			...
			}, [t.files && t.params.limit > t.files.length ? (g(), r("span", ND, [
				s[29] ||= i("i", { class: "bi bi-upload me-2" }, null, -1),
				a(" " + b(t.params.text) + " ", 1),
				t.params.limit ? (g(), r("small", PD, [
					s[26] ||= a(" ( ", -1),
					i("strong", FD, b(t.files.length), 1),
					s[27] ||= a(" / ", -1),
					i("span", ID, b(t.params.limit), 1),
					s[28] ||= a(" ) ", -1)
				])) : n("", !0)
			])) : (g(), r("span", LD, [...s[30] ||= [i("i", { class: "bi bi-exclamation-circle" }, null, -1), a(" You've reached the upload limit ", -1)]]))], 42, MD),
			i("button", {
				type: "button",
				class: "btn btn-outline-primary ms-1",
				onClick: s[9] ||= (e) => t.toggleView()
			}, [t.params.ui == "list" ? n("", !0) : (g(), r("i", RD)), t.params.ui == "list" ? (g(), r("i", zD)) : n("", !0)]),
			i("button", {
				disabled: !t.files.length,
				type: "button",
				class: "btn btn-outline-danger ms-1",
				onClick: s[10] ||= (e) => t.resetConfirm()
			}, [...s[31] ||= [i("i", { class: "bi bi-trash" }, null, -1)]], 8, BD)
		]), i("div", VD, [i("small", null, [t.params.accept ? (g(), r("div", HD, [s[32] ||= i("span", { class: "text-secondary" }, "accept only", -1), (g(!0), r(e, null, v(t.params.accept, (e) => (g(), r("strong", {
...
var GD = /* @__PURE__ */ NT(mE, [["render", WD]]), KD = {
	props: {
...
function YD(t, n, i, a, o, s) {
	return D((g(), r("select", {
		...
		key: e,
		value: e.value
	}, b(e.label ? e.label : e.value), 11, JD))), 128))], 42, qD)), [[w, t.newitem]]);
}
var XD = /* @__PURE__ */ NT(KD, [["render", YD]]), ZD = {
	props: {
		modelValue: Array,
		field: Object,
		item: Object,
	...
	components: { VuAdminFormSelect: XD }
}, QD = { class: "row g-1 d-flex align-items-center justify-content-between mb-1" }, $D = { class: "col-10" }, eO = { class: "row g-1 d-flex align-items-center justify-content-between" }, tO = { class: "col-10" }, nO = { class: "row g-1 d-flex align-items-center justify-content-between" }, rO = ["innerHTML"], iO = {
	key: 1,
	...
	"placeholder",
	"onUpdate:modelValue"
], oO = { class: "col-2 text-nowrap text-end" }, sO = ["onClick"], cO = ["onClick"], lO = ["onClick"], uO = { key: 0 }, dO = { class: "row g-1 d-flex align-items-center justify-content-between" }, fO = { class: "col-10" }, pO = { class: "row g-1 d-flex align-items-center justify-content-between" }, mO = { class: "input-group input-group-sm" }, hO = {
	key: 0,
...
function yO(a, o, s, c, l, u) {
	let d = y("VuAdminFormSelect");
	return g(), r("div", null, [
		i("div", QD, [i("div", $D, [i("div", eO, [(g(!0), r(e, null, v(a.field.elements, (e) => (g(), r("div", {
			key: e,
			class: p(e.class || "col")
		...
		(g(!0), r(e, null, v(a.value, (s, c) => (g(), r("div", {
			...
			key: c
		}, [i("div", tO, [i("div", nO, [(g(!0), r(e, null, v(s, (e, n) => (g(), r("div", {
			key: n,
		...
		}, null, 8, rO)) : (g(), r("div", iO, [a.field.elements[n].type == "select" && a.value[c][n] ? (g(), t(d, {
			key: 0,
			...
			class: "form-control",
			"onUpdate:modelValue": (e) => a.value[c][n] = e
		}, null, 8, aO)), [[C, a.value[c][n]]])]))], 2))), 128))])]), i("div", oO, [
			a.field.sortable ? (g(), r("button", {
				key: 0,
				type: "button",
				class: "btn btn-sm btn-outline-secondary p-1 me-1",
				onClick: (e) => a.arrayItemMoveUp(a.value, c)
			}, [...o[2] ||= [i("i", { class: "bi bi-arrow-up" }, null, -1)]], 8, sO)) : n("", !0),
			a.field.sortable ? (g(), r("button", {
				key: 1,
				type: "button",
				class: "btn btn-sm btn-outline-secondary p-1 me-1",
				onClick: (e) => a.arrayItemMoveDown(a.value, c + 1)
			}, [...o[3] ||= [i("i", { class: "bi bi-arrow-down" }, null, -1)]], 8, cO)) : n("", !0),
			i("button", {
				type: "button",
				class: "btn btn-sm btn-outline-danger p-1 me-1",
				onClick: (e) => a.arrayRemoveItem(a.value, c)
			}, [...o[4] ||= [i("i", { class: "bi bi-trash" }, null, -1)]], 8, lO)
		])]))), 128)),
		a.item[a.field.name] && a.item[a.field.name].length ? (g(), r("hr", uO)) : n("", !0),
		i("div", dO, [i("div", fO, [i("div", pO, [(g(!0), r(e, null, v(a.field.elements, (e) => (g(), r("div", {
			key: e,
			class: p(e.class || "col")
		}, [i("div", mO, [
			e.prefix ? (g(), r("span", hO, b(e.prefix), 1)) : n("", !0),
			...
			e.suffix ? (g(), r("span", _O, b(e.suffix), 1)) : n("", !0)
		]), n("", !0)], 2))), 128))])]), i("div", vO, [i("button", {
			type: "button",
...
var bO = {
	...
	components: {
		HtmlEditor: WT,
		FileUpload: GD,
		VuAdminFormSelect: XD,
		VuAdminFormList: /* @__PURE__ */ NT(ZD, [["render", yO]])
	}
}, xO = { class: "row m-1" }, SO = ["innerHTML"], CO = {
	key: 1,
	class: "row"
}, wO = { class: "form-group pb-3" }, TO = { key: 0 }, EO = {
	key: 0,
	...
	"readonly",
	"required"
], RO = ["innerHTML"], zO = { class: "dropdown d-inline-block" }, BO = { class: "dropdown-menu" }, VO = ["onClick"], HO = {
	key: 0,
	class: "bi bi-check-square"
}, UO = {
	key: 1,
	class: "bi bi-square"
}, WO = ["onClick"], GO = ["onClick"], KO = ["onClick"], qO = ["onClick"], JO = { key: 6 }, YO = { key: 0 }, XO = ["for"], ZO = [
	"name",
	"id",
	"onUpdate:modelValue"
], QO = ["onClick"], $O = ["innerHTML"], ek = {
	key: 8,
	class: "p-1"
}, tk = ["innerHTML"];
function nk(o, s, c, l, u, d) {
	let f = y("VuAdminFormSelect"), m = y("HtmlEditor"), h = y("FileUpload"), _ = y("VuAdminFormList");
	return g(), r("div", xO, [(g(!0), r(e, null, v(o.settings.form.groups, (c) => (g(), r("div", {
		key: c,
	...
	}, null, 8, SO)) : n("", !0), o.item && c.fields ? (g(), r("div", CO, [(g(!0), r(e, null, v(c.fields, (c) => (g(), r("div", {
		...
		}, [a(b(c.label ? c.label : o.translate(c.name)) + " ", 1), c.maxlength ? (g(), r("span", EO, b(o.item[c.name] ? o.item[c.name].length : 0) + " / " + b(c.maxlength), 1)) : n("", !0)], 2)) : (g(), r("label", {
			key: 1,
			class: p([{ required: c.required }, "form-label text-secondary mb-1"]),
		...
		[
			...
			c.type == "text" ? D((g(), r("input", {
				...
				readonly: c.readonly,
				required: c.required
			}, null, 10, AO)), [[T, o.item[c.name]]]) : n("", !0),
			c.type == "number" ? D((g(), r("input", {
				...
				readonly: c.readonly,
				required: c.required
			}, null, 10, jO)), [[T, o.item[c.name]]]) : n("", !0),
			[
				"date",
				"datetime",
				"datetime-local"
				...
				readonly: c.readonly,
				required: c.required
			}, null, 10, MO)), [[C, o.item[c.name]]]) : n("", !0),
			c.type == "checkbox" ? (g(), r("div", NO, [D(i("input", {
				...
				readonly: c.readonly,
				required: c.required
			}, null, 10, PO), [[S, o.item[c.name]]]), i("label", {
				class: "form-check-label cursor-pointer",
				for: o.formId + "_" + c.name
			}, b(c.checkbox), 9, FO)])) : n("", !0),
			c.type == "email" ? D((g(), r("input", {
				...
				disabled: c.disabled,
				required: c.required
			}, null, 10, IO)), [[T, o.item[c.name]]]) : n("", !0),
		...
		c.type == "dropdown" && o.item[c.name] ? (g(), r("div", {
			...
			"data-bs-toggle": "dropdown",
			"aria-expanded": "false"
		}, [i("span", null, b(o.translate(c.dropdown ? c.dropdown.label : "Select")), 1)], 2), i("ul", BO, [
			...
			key: e,
			onClick: (t) => o.dropdownSelectToggleOne(c, o.item[c.name], e)
		}, [a(b(o.translate(e)) + " ", 1), s[1] ||= i("i", { class: "bi bi-x" }, null, -1)], 10, qO))), 128))], 2)) : n("", !0)], 2)) : n("", !0),
		c.type == "addresses" ? (g(), r("span", JO, [o.item[c.name] ? (g(), r("div", YO, [(g(!0), r(e, null, v(o.item[c.name], (e) => (g(), r("div", { key: e }, [
			a(b(e) + " ", 1),
			i("label", {
		...
		c.description ? (g(), r("div", ek, [i("small", null, [i("i", {
			class: "text-muted",
...
var rk = {
	...
	components: { VuAdminFormGroup: /* @__PURE__ */ NT(bO, [["render", nk]]) }
}, ik = ["id", "data-bs-theme"], ak = { class: "modal-header" }, ok = {
	key: 0,
	class: "modal-title"
}, sk = ["innerHTML"], ck = { key: 1 }, lk = { key: 2 }, uk = {
	key: 3,
...
}, gk = { class: "dropdown d-inline-block" }, _k = ["innerHTML"], vk = { class: "dropdown-menu text-start" }, yk = { class: "me-2 text-muted" }, bk = ["innerHTML"], xk = ["disabled", "onClick"], Sk = {
	key: 1,
	class: "dropdown d-inline-block"
}, Ck = { class: "mx-1" }, wk = { class: "dropdown-menu px-2" }, Tk = ["onClick"], Ek = {
	key: 1,
	...
	return o.item ? (g(), r("form", {
		...
		i("div", ak, [
			o.loaded ? (g(), r("h5", ok, [
				...
				o.settings.form.title && typeof o.settings.form.title == "string" ? (g(), r("span", ck, b(o.translate(o.settings.form.title)), 1)) : n("", !0),
				o.settings.form.title ? n("", !0) : (g(), r("span", lk, b(o.translate("Edit")), 1)),
				o.item[o.settings.pkey] ? (g(), r("small", uk, [s[2] ||= i("span", { class: "text-muted fw-light" }, "id", -1), a(" " + b(o.item[o.settings.pkey]), 1)])) : n("", !0)
			])) : n("", !0),
			o.message.form ? (g(), r("span", dk, [i("span", { class: p(["text-" + o.message.form.priority]) }, [s[3] ||= i("i", { class: "bi bi-envelope-fill me-2" }, null, -1), i("span", { innerHTML: o.message.form.msg }, null, 8, fk)], 2)])) : n("", !0),
			D(i("span", pk, [...s[4] ||= [i("span", { class: "visually-hidden" }, "Loading...", -1)]], 512), [[E, o.ui.wait.form]]),
			s[5] ||= i("button", {
				type: "button",
				class: "btn-close",
		...
		o.item ? (g(), r("div", mk, [o.settings.form.control ? (g(), r("div", {
		...
		}, null, 10, _k), i("ul", vk, [(g(!0), r(e, null, v(o.messages.form, (e) => (g(), r("li", { key: e }, [i("span", { class: p(["dropdown-item disabled", ["text-" + e.priority]]) }, [i("small", yk, b(e.datetime), 1), i("span", { innerHTML: e.msg }, null, 8, bk)], 2)]))), 128))])])])) : n("", !0), (g(!0), r(e, null, v(o.settings.form.control.buttons, (t) => (g(), r("span", { key: t.action }, [t.dropdowns ? n("", !0) : (g(), r("button", {
			key: 0,
			type: "button",
			...
			item: o.item,
			form: this
		})]) }, null, 2), a(" " + b(o.translate(t.title)), 1)], 10, xk)), t.dropdowns ? (g(), r("div", Sk, [i("button", {
			type: "button",
			class: p([[t.class], "dropdown-toggle"]),
			"data-bs-toggle": "dropdown",
			"data-bs-auto-close": "outside",
			"aria-expanded": "false"
		}, [i("span", Ck, [i("i", { class: p([t.icon === void 0 ? o.getButtonIconClassByAction(t.action) : o.getValueOrFunction(t.icon, {
			button: t,
			table: this
		})]) }, null, 2), a(" " + b(o.translate(t.title)), 1)])], 2), i("ul", wk, [(g(!0), r(e, null, v(t.dropdowns, (e) => (g(), r("li", { key: e }, [i("span", {
			...
			key: 0,
			class: p([e.icon])
		}, null, 2)) : n("", !0), a(" " + b(o.translate(e.title)), 1)], 10, Tk)]))), 128))])])) : n("", !0)]))), 128))], 2)) : n("", !0)])) : n("", !0),
		o.settings.form ? (g(), r("div", Ek, [o.settings.form.visible && o.settings.form.groups ? (g(), t(f, {
			key: 0,
			modelValue: o.item,
		...
		o.item ? (g(), r("div", Dk)) : n("", !0),
		o.settings.debug > 1 ? (g(), r("pre", Ok, "        " + b(o.item) + "\n    ", 1)) : n("", !0)
	], 42, ik)) : n("", !0);
}
var Ak = /* @__PURE__ */ NT(rk, [["render", kk]]), jk = {
...
}, Nk = { class: "dropdown d-inline-block m-1" }, Pk = { class: "mx-1" }, Fk = { key: 0 }, Ik = {
	key: 0,
	class: "dropdown-menu text-end"
}, Lk = ["onClick"], Rk = { class: "ms-2" }, zk = {
	key: 0,
	...
	class: "spinner-border spinner-border-sm mx-2",
	role: "status"
}, Hk = { class: "pagination pagination-sm m-1" }, Uk = { class: "page-item" }, Wk = ["innerHTML"], Gk = { class: "page-item" }, Kk = ["innerHTML"], qk = ["onClick"], Jk = { class: "page-item" }, Yk = ["innerHTML"], Xk = {
	key: 0,
	class: "page-item"
}, Zk = ["innerHTML"];
function Qk(t, a, o, s, c, l) {
	return o.config.pagination.hidden ? n("", !0) : (g(), r("nav", Mk, [i("div", null, [i("div", Nk, [i("button", {
		type: "button",
		class: p(["btn btn-sm btn-secondary", { "dropdown-toggle": o.config.pagination.limits }]),
		"data-bs-toggle": "dropdown",
		"aria-expanded": "false"
	}, [D(i("span", Pk, [i("strong", null, b(o.config.pagination.from) + "-" + b(o.config.pagination.to), 1), o.config.pagination.total ? (g(), r("span", Fk, " / " + b(o.config.pagination.total), 1)) : n("", !0)], 512), [[E, o.config.pagination.from > 0]])], 2), o.config.pagination.limits ? (g(), r("ul", Ik, [i("li", null, [(g(!0), r(e, null, v(o.config.pagination.limits, (e) => (g(), r("span", {
		class: p(["dropdown-item cursor-pointer", { selected: o.config.pagination.limit == e }]),
		key: e,
		onClick: (t) => l.setPageLimit(e)
	}, [
		i("strong", null, b(e), 1),
		i("small", Rk, b(l.translate("row")) + "/" + b(l.translate("page")), 1),
		o.config.pagination.limit == e ? (g(), r("i", zk)) : n("", !0),
		o.config.pagination.limit == e ? n("", !0) : (g(), r("i", Bk))
	], 10, Lk))), 128))])])) : n("", !0)]), D(i("div", Vk, [...a[4] ||= [i("span", { class: "visually-hidden" }, "Loading...", -1)]], 512), [[E, o.ui && o.ui.wait.table]])]), i("ul", Hk, [
		i("li", Uk, [i("a", {
		...
		o.config.pagination.total ? (g(), r("li", Xk, [i("a", {
...
var $k = /* @__PURE__ */ NT(jk, [["render", Qk]]), eA = kc(), tA = {
	name: "VuAdminTable",
	props: {
		settings: Object,
		auth: Object
	...
	methods: {
		...
		listenEvent() {
			if (eA.on(`EDIT-${this.settings.entity}`, (e) => {
				...
				this._filterListenerRegistered ||= (eA.on(t, (t) => {
...
}, nA = ["data-bs-theme"], rA = { class: "vua-table-title" }, iA = { class: "d-flex align-items-center justify-content-between" }, aA = { class: "d-inline-block" }, oA = {
	key: 0,
...
}, uA = ["innerHTML"], dA = { class: "dropdown d-inline-block" }, fA = ["innerHTML"], pA = { class: "dropdown-menu text-start" }, mA = { class: "me-2 text-muted" }, hA = ["innerHTML"], gA = ["onClick"], _A = {
	key: 1,
	class: "dropdown d-inline-block"
}, vA = { class: "mx-1" }, yA = { key: 0 }, bA = { class: "dropdown-menu" }, xA = ["onClick"], SA = {
	key: 0,
	class: "bi bi-check-square-fill me-2"
}, CA = {
	key: 1,
	class: "bi bi-x-square me-2 text-danger"
}, wA = { class: "badge text-secondary fw-normal" }, TA = {
	key: 2,
	class: "dropdown d-inline-block"
}, EA = { class: "mx-1" }, DA = { class: "dropdown-menu" }, OA = ["onClick"], kA = { class: "vua-table-header" }, AA = ["width"], jA = ["onClick"], MA = ["innerHTML"], NA = {
	key: 0,
	class: "bi bi-arrow-down"
}, PA = {
	key: 1,
	class: "bi bi-arrow-up"
}, FA = { key: 0 }, IA = ["disabled", "onClick"], LA = {
	key: 0,
	class: "vua-table-filter"
}, RA = ["width"], zA = {
	key: 0,
	class: "d-inline-block w-100 px-1"
}, BA = { class: "bi bi-check-all" }, VA = { class: "bi bi-x-lg" }, HA = {
	key: 1,
	class: "input-group input-group-sm my-1"
}, UA = ["onUpdate:modelValue"], WA = ["disabled", "onClick"], GA = {
	key: 2,
	class: "input-group input-group-sm my-1"
}, KA = ["onUpdate:modelValue", "disabled"], qA = { value: "=" }, JA = { value: ">" }, YA = { value: ">=" }, XA = { value: "<" }, ZA = { value: "<=" }, QA = ["onUpdate:modelValue", "disabled"], $A = ["value"], ej = [
	"onUpdate:modelValue",
	"disabled",
	"min",
	"max"
], tj = ["disabled", "onClick"], nj = { key: 3 }, rj = {
	key: 0,
	class: "dropdown"
}, ij = {
	...
	"data-bs-toggle": "dropdown",
	"aria-expanded": "false"
}, aj = { class: "dropdown-menu" }, oj = ["onClick"], sj = {
	key: 0,
	class: "bi bi-check-square"
}, cj = {
	key: 1,
	class: "bi bi-square"
}, lj = { key: 0 }, uj = { key: 1 }, dj = ["onClick"], fj = { key: 2 }, pj = ["onClick"], mj = { key: 3 }, hj = ["onClick"], gj = {
	key: 1,
	class: "input-group input-group-sm my-1"
}, _j = ["onUpdate:modelValue", "multiple"], vj = ["value"], yj = ["disabled", "onClick"], bj = {
	key: 4,
	class: "input-group input-group-sm my-1"
}, xj = ["onUpdate:modelValue"], Sj = { value: "=" }, Cj = { value: ">" }, wj = { value: ">=" }, Tj = { value: "<" }, Ej = { value: "<=" }, Dj = ["onUpdate:modelValue"], Oj = ["value"], kj = ["type", "onUpdate:modelValue"], Aj = ["disabled", "onClick"], jj = ["disabled", "onClick"], Mj = { class: "align-middle" }, Nj = [
	"data-label",
	"width",
	"onClick"
], Pj = {
	key: 0,
	class: "d-inline-block w-100 px-1"
}, Fj = ["innerHTML"], Ij = { key: 1 }, Lj = ["innerHTML"], Rj = ["aria-valuenow", "aria-valuemax"], zj = { key: 0 }, Bj = {
	key: 4,
	class: "input-group input-group-sm"
}, Vj = ["innerHTML"], Hj = {
	key: 1,
	...
	"onChange",
	"onUpdate:modelValue"
], Gj = ["onChange", "onUpdate:modelValue"], Kj = ["value"], qj = ["innerHTML"], Jj = {
	key: 5,
	class: "input-group-text"
}, Yj = [
	"name",
	"onUpdate:modelValue",
	"onChange"
], Xj = { key: 5 }, Zj = ["disabled", "onClick"], Qj = ["innerHTML"], $j = { key: 2 }, eM = { key: 0 }, tM = ["colspan"], nM = { class: "row g-3 align-items-center" }, rM = { class: "col-form-label" }, iM = [
	"type",
	"onUpdate:modelValue",
	"onChange"
], aM = ["onUpdate:modelValue", "onChange"], oM = ["onUpdate:modelValue", "onChange"], sM = ["value"], cM = ["innerHTML"], lM = {
	key: 0,
	class: "bg-light text-dark"
}, uM = {
	key: 0,
	class: "vua-table-bulk border-info"
}, dM = ["data-label", "width"], fM = {
	key: 0,
	class: "d-inline-block w-100 px-1"
}, pM = {
	key: 1,
	...
	"onChange",
	"onUpdate:modelValue"
], gM = ["value"], _M = ["onClick"], vM = {
	key: 0,
	class: "bi bi-square text-secondary"
}, yM = {
	key: 1,
	class: "bi bi-check-square"
}, bM = { key: 2 }, xM = ["disabled", "onClick"], SM = ["innerHTML"], CM = { key: 2 }, wM = ["id"], TM = { class: "modal-dialog modal-xl" }, EM = { class: "modal-content h-100" };
function DM(s, c, l, u, d, f) {
	...
	return g(), r("div", null, [f.authAndSettings() ? (g(), r("div", {
		...
		i("div", rA, [i("div", iA, [i("div", aA, [l.settings.table.title ? (g(), r("h5", oA, b(l.settings.table.title), 1)) : n("", !0), D(i("div", sA, [...c[15] ||= [i("span", { class: "visually-hidden" }, "Loading...", -1)]], 512), [[E, d.ui.wait.table && l.settings.table.title]])]), d.messages.table.length ? (g(), r("div", cA, [d.message.table ? (g(), r("small", lA, [i("span", { class: p(["text-" + d.message.table.priority]) }, [i("span", {
			class: "fw-bold",
			innerHTML: d.message.table.msg
		}, null, 8, uA)], 2)])) : n("", !0), i("div", dA, [i("button", {
		...
		}, null, 10, fA), i("ul", pA, [(g(!0), r(e, null, v(d.messages.table, (e) => (g(), r("li", { key: e }, [i("span", { class: p(["dropdown-item", ["text-" + e.priority]]) }, [i("small", mA, b(e.datetime), 1), i("span", {
			class: "fw-bold",
			innerHTML: e.msg
		}, null, 8, hA)], 2)]))), 128))])])])) : n("", !0)])]),
		l.settings.table.control ? (g(), r("div", {
			...
			t.action !== "TABLE_COLUMNS" && !t.dropdowns ? (g(), r("button", {
				...
				button: t,
				table: this
			})]) }, null, 2), a(" " + b(f.translate(t.title)), 1)], 10, gA)) : n("", !0),
			t.action === "TABLE_COLUMNS" ? (g(), r("div", _A, [i("button", {
				type: "button",
				...
				f.countHiddenColumns() ? (g(), r("span", yA, " ( " + b(f.countHiddenColumns()) + " " + b(f.translate("hidden")) + " ) ", 1)) : n("", !0)
			], 512), [[E, l.settings.table.columns.length > 0]])], 2), i("ul", bA, [
				(g(!0), r(e, null, v(l.settings.table.columns, (e) => (g(), r("li", { key: e }, [i("span", {
					class: "dropdown-item cursor-pointer",
					onClick: (t) => f.toggleColumn(e)
				}, [
					e.hidden ? n("", !0) : (g(), r("i", SA)),
					e.hidden ? (g(), r("i", CA)) : n("", !0),
					a(" " + b(e.title) + " ", 1),
					i("small", wA, b(e.name), 1)
				], 8, xA)]))), 128)),
			...
			t.dropdowns ? (g(), r("div", TA, [i("button", {
				type: "button",
				class: p([[t.class], "dropdown-toggle"]),
				"data-bs-toggle": "dropdown",
				"data-bs-auto-close": "outside",
				"aria-expanded": "false"
			}, [i("span", EA, [i("i", { class: p([t.icon === void 0 ? f.getButtonIconClassByAction(t.action) : f.getValueOrFunction(t.icon, {
				button: t,
				table: this
			})]) }, null, 2), a(" " + b(f.translate(t.title)), 1)])], 2), i("ul", DA, [(g(!0), r(e, null, v(t.dropdowns, (e) => (g(), r("li", { key: e }, [i("span", {
				...
				key: 0,
				class: p([e.icon])
			}, null, 2)) : n("", !0), a(" " + b(f.translate(e.title)), 1)], 10, OA)]))), 128))])])) : n("", !0)
		]))), 128))], 2)) : n("", !0),
		l.settings.table ? (g(), r("table", {
			key: 1,
			class: p(["table vua-table mb-0", [l.settings.table.class]])
		}, [
			i("thead", null, [i("tr", kA, [(g(!0), r(e, null, v(l.settings.table.columns, (t) => (g(), r("th", {
			...
			}, [i("span", { innerHTML: t.header && t.header.title !== void 0 ? f.translate(t.header.title) : t.title ? f.translate(t.title) : f.translate(t.name) }, null, 8, MA), d.config.order[t.name] ? (g(), r("span", {
				key: 0,
				class: p(["badge text-bg-light ms-1 p-badge", { "opacity-50": d.config.order[t.name].fixed }])
			}, [
				d.config.order[t.name].dir === "ASC" ? (g(), r("i", NA)) : n("", !0),
				d.config.order[t.name].dir === "DESC" ? (g(), r("i", PA)) : n("", !0),
				a(" " + b(d.config.order[t.name].idx + 1), 1)
			], 2)) : n("", !0)], 10, jA), t.header && t.header.buttons ? (g(), r("span", FA, [(g(!0), r(e, null, v(t.header.buttons, (e) => (g(), r("button", {
				key: e.action,
				type: "button",
				...
				column: t,
				table: this
			})]) }, null, 2), a(" " + b(f.translate(e.title)), 1)], 10, IA))), 128))])) : n("", !0)], 14, AA))), 128))]), f.countFilters() ? (g(), r("tr", LA, [(g(!0), r(e, null, v(l.settings.table.columns, (t) => (g(), r("th", {
				style: m([t.hidden ? "display: none" : ""]),
				key: t,
				width: t.width,
				class: p([t.filter ? t.filter.class : ""])
			}, [
				t.index && t.click ? (g(), r("div", zA, [i("span", {
				...
				}, [D(i("i", BA, null, 512), [[E, !f.haveSelectedRowInPage()]]), D(i("i", VA, null, 512), [[E, f.haveSelectedRowInPage()]])], 2)])) : n("", !0),
				t.filter && t.filter.type == "text" ? (g(), r("div", HA, [D(i("input", {
					type: "text",
				...
				}, null, 42, UA), [[T, t.filter.value]]), t.filter.buttonx && t.filter.buttonx != 0 ? (g(), r("button", {
					key: 0,
				...
				}, [...c[17] ||= [i("i", { class: "bi bi-x" }, null, -1)]], 10, WA)) : n("", !0)])) : n("", !0),
				t.filter && t.filter.type == "number" ? (g(), r("div", GA, [
					t.filter.operators == 1 ? D((g(), r("select", {
						...
						i("option", qA, b(f.translate("=")), 1),
						i("option", JA, b(f.translate(">")), 1),
						i("option", YA, b(f.translate(">=")), 1),
						i("option", XA, b(f.translate("<")), 1),
						i("option", ZA, b(f.translate("<=")), 1)
					], 40, KA)), [[w, t.filter.operator]]) : n("", !0),
					t.filter.operators && t.filter.operators.length > 0 ? D((g(), r("select", {
						...
						key: e,
						value: e.value
					}, b(e.label), 9, $A))), 128))], 40, QA)), [[w, t.filter.operator]]) : n("", !0),
					D(i("input", {
						type: "number",
					...
					}, [...c[18] ||= [i("i", { class: "bi bi-x" }, null, -1)]], 10, tj)) : n("", !0)
				])) : n("", !0),
				t.filter && t.filter.type == "select" ? (g(), r("div", nj, [t.filter.dropdown ? (g(), r("div", rj, [i("button", ij, b(t.filter.multiple ? t.filter.value.length + " selected" : t.filter.value ? t.filter.value : "not selected"), 1), i("ul", aj, [
					...
					}, [(t.filter.multiple ? t.filter.value.indexOf(e.value) >= 0 : t.filter.value === e.value) ? (g(), r("i", sj)) : (g(), r("i", cj)), a(" " + b(f.translate(e.label ? e.label : e.value)), 1)], 10, oj))), 128))]),
					t.filter.multiple ? (g(), r("li", lj, [...c[19] ||= [i("hr", { class: "dropdown-divider" }, null, -1)]])) : n("", !0),
					t.filter.multiple ? (g(), r("li", uj, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => f.dropdownSelectAll(t.filter.value, t.filter.options)
					}, b(f.translate("Select all")), 9, dj)])) : n("", !0),
					t.filter.multiple ? (g(), r("li", fj, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => f.dropdownSelectClear(t.filter.value)
					}, b(f.translate("Unselect all")), 9, pj)])) : n("", !0),
					t.filter.multiple ? (g(), r("li", mj, [i("span", {
						class: "dropdown-item cursor-pointer",
						onClick: (e) => f.dropdownSelectInvert(t.filter.value, t.filter.options)
					}, b(f.translate("Invert all")), 9, hj)])) : n("", !0)
				])])) : (g(), r("div", gj, [D(i("select", {
					"onUpdate:modelValue": (e) => t.filter.value = e,
					...
					key: e,
					value: e.value
				}, b(f.translate(e.label ? e.label : e.value)), 9, vj))), 128))], 40, _j), [[w, t.filter.value]]), t.filter.buttonx && t.filter.buttonx != 0 ? (g(), r("button", {
					key: 0,
					class: p(["btn btn-outline-secondary", { "opacity-25": t.filter.value == null }]),
					disabled: t.filter.value == null,
					onClick: (e) => {
				...
				}, [...c[20] ||= [i("i", { class: "bi bi-x" }, null, -1)]], 10, yj)) : n("", !0)]))])) : n("", !0),
				t.filter && (t.filter.type == "datetime-local" || t.filter.type == "date") ? (g(), r("div", bj, [
					t.filter.operators == 1 ? D((g(), r("select", {
						key: 0,
						"onUpdate:modelValue": (e) => t.filter.operator = e,
						...
						i("option", Sj, b(f.translate("=")), 1),
						i("option", Cj, b(f.translate(">")), 1),
						i("option", wj, b(f.translate(">=")), 1),
						i("option", Tj, b(f.translate("<")), 1),
						i("option", Ej, b(f.translate("<=")), 1)
					], 40, xj)), [[w, t.filter.operator]]) : n("", !0),
					t.filter.operators && t.filter.operators.length > 0 ? D((g(), r("select", {
						key: 1,
						"onUpdate:modelValue": (e) => t.filter.operator = e,
						...
						key: e,
						value: e.value
					}, b(f.translate(e.label)), 9, Oj))), 128))], 40, Dj)), [[w, t.filter.operator]]) : n("", !0),
					D(i("input", {
						type: t.filter.type,
						class: p([{ fixed: t.filter.fixed }, "form-control form-control-sm"]),
						"onUpdate:modelValue": (e) => t.filter.value = e,
					...
					}, [...c[21] ||= [i("i", { class: "bi bi-x" }, null, -1)]], 10, Aj)
				])) : n("", !0),
				t.filter && t.filter.buttons ? (g(), r("span", {
					...
					column: t,
					table: this
				})]) }, null, 2), a(" " + b(f.translate(e.title)), 1)], 10, jj)]))), 128))], 2)) : n("", !0)
			], 14, RA))), 128))])) : n("", !0)]),
			i("tbody", null, [(g(!0), r(e, null, v(this.items, (t, a) => (g(), r(e, { key: t.id }, [i("tr", Mj, [(g(!0), r(e, null, v(l.settings.table.columns, (o) => (g(), r("td", {
				...
				!o.template && !o.input && !o.progressbar ? (g(), r("span", Ij, b(f.tableCellValue(o.name, t, a, o)), 1)) : n("", !0),
				o.template ? (g(), r("span", {
					key: 2,
				...
				}, [o.progressbar.value ? (g(), r("span", zj, b(t[o.name]), 1)) : n("", !0)], 6)], 8, Rj)) : n("", !0),
				o.input ? (g(), r("div", Bj, [
					...
					o.input.prefixcheck ? (g(), r("span", Hj, [D(i("input", {
					...
					}, null, 40, Uj), [[S, t[o.input.prefixcheck.name]]])])) : n("", !0),
					[
						"text",
						"number",
						"date",
					...
					o.input.type == "select" ? D((g(), r("select", {
						...
						value: e.value,
						key: e
					}, b(f.translate(e.label)), 9, Kj))), 128))], 42, Gj)), [[w, t[o.name]]]) : n("", !0),
					...
					o.input.suffixcheck ? (g(), r("span", Jj, [D(i("input", {
						class: "form-check p-0 m-0",
						type: "checkbox",
					...
					}, null, 40, Yj), [[S, t[o.input.suffixcheck.name]]])])) : n("", !0)
				])) : n("", !0),
				o.buttons ? (g(), r("span", Xj, [(g(!0), r(e, null, v(o.buttons, (e) => (g(), r("span", { key: e.action }, [e.hidden ? n("", !0) : (g(), r("button", {
					key: 0,
					type: "button",
					disabled: e.disabled === void 0 ? null : f.getValueOrFunction(e.disabled),
				...
				}, null, 8, Qj)) : (g(), r("span", $j, b(f.translate(e.title)), 1))], 10, Zj))]))), 128))])) : n("", !0)
			], 14, Nj))), 128))]), l.settings.table.details && d.details.indexOf(t[l.settings.pkey]) >= 0 ? (g(), r("tr", eM, [i("td", {
				...
				(g(!0), r(e, null, v(l.settings.table.details.fields, (o) => (g(), r("div", {
					class: "m-0",
					key: o
				}, [i("div", nM, [i("div", { class: p(["col text-end", [o.class]]) }, [i("label", rM, b(o.label), 1)], 2), i("div", { class: p(["col", [o.input.class]]) }, [
					...
					o.input.type == "select" ? D((g(), r("select", {
						...
						value: e.value,
						key: e
					}, b(f.translate(e.label)), 9, sM))), 128))], 40, oM)), [[w, t[o.name]]]) : n("", !0)
				], 2)])]))), 128)),
				i("span", { innerHTML: l.settings.table.details.raw(t) }, null, 8, cM),
				l.settings.debug > 1 ? (g(), r("pre", lM, "                  " + b(t) + "\n                ", 1)) : n("", !0)
			], 10, tM)])) : n("", !0)], 64))), 128))]),
			i("tfoot", null, [d.selected.length > 0 ? (g(), r("tr", uM, [(g(!0), r(e, null, v(l.settings.table.columns, (t) => (g(), r("td", {
				style: m([t.hidden ? "display: none" : ""]),
				key: t.name,
				"data-label": t.title,
				width: t.width,
				...
				t.input && t.bulk && t.bulk.enabled ? (g(), r("div", pM, [
					[
						"text",
						"number",
						"date",
					...
					}, null, 42, mM)), [[C, d.bulkitem[t.name]]]) : n("", !0),
					t.input.type == "select" ? D((g(), r("select", {
						...
						value: e.value,
						key: e
					}, b(f.translate(e.label)), 9, gM))), 128))], 42, hM)), [[w, d.bulkitem[t.name]]]) : n("", !0),
					i("span", {
						class: "input-group-text cursor-pointer",
						onClick: (e) => f.ifBulkInputClick(t)
					}, [d.bulkitem[t.name] === void 0 ? (g(), r("i", vM)) : (g(), r("i", yM))], 8, _M)
				])) : n("", !0),
				t.bulk ? (g(), r("span", bM, [(g(!0), r(e, null, v(t.bulk.buttons, (e) => (g(), r("span", { key: e.action }, [i("button", {
					type: "button",
					class: p([e.class ? e.class : f.getButtonClassByAction(e.action)]),
				...
				}, null, 8, SM)) : (g(), r("span", CM, b(f.translate(e.title)), 1))], 10, xM)]))), 128))])) : n("", !0)
			], 14, dM))), 128))])) : n("", !0)])
		], 2)) : n("", !0),
		o(h, {
			settings: l.settings,
		...
		id: d.modalId,
		tabindex: "-1"
	}, [i("div", TM, [i("div", EM, [f.authAndSettings() && l.settings.form.visible && l.settings.form.groups ? (g(), t(_, {
		key: 0,
		modelValue: d.item,
...
var OM = {
	...
	components: { VuAdminTable: /* @__PURE__ */ NT(tA, [["render", DM]]) }
}, kM = { key: 0 }, AM = ["data-bs-theme"];
function jM(e, t, i, a, s, c) {
	let l = y("vu-admin-table");
	return e.entity && e.settings ? (g(), r("div", kM, [e.auth ? (g(), r("div", {
		key: 0,
		class: "vu-admin",
		...
		settings: e.settings,
		auth: e.auth
	}, null, 8, ["settings", "auth"])], 8, AM)) : n("", !0)])) : n("", !0);
}
var MM = /* @__PURE__ */ NT(OM, [["render", jM]]), NM = (/* @__PURE__ */ re(((e, t) => {
	(function() {
...
var PM = {
	...
	methods: {
		...
		async generateHash(e, t) {
			let n = e;
			for (let e = 0; e < t; e++) n = (0, NM.sha512)(n);
			return n;
		},
		authUpdate() {
	...
	mounted() {
		...
		}, console.log(this.auth), this.checkStorage(), this.reset(), this.updateInputs(), this.$forceUpdate(), this.detectQuery(), this.captchaRequired && this.fetchCaptcha(), this.settings.debug && console.log("vu-auth mounted ", "1.4.3");
	},
	beforeUnmount() {
		window.removeEventListener("keydown", this.handleEscapeKey);
	}
}, FM = ["data-bs-theme"], IM = { class: "col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 mx-auto" }, LM = { class: "position-absolute top-0 end-0 p-0 m-2" }, RM = {
	key: 0,
	class: "spinner-border spinner-border-sm text-primary"
}, zM = { class: "text-center mt-2 mb-4" }, BM = {
	key: 0,
	class: "mb-3"
}, VM = {
	for: "email",
	class: "form-label text-primary"
}, HM = { class: "input-group" }, UM = [
	"type",
	"placeholder",
	"disabled"
], WM = ["innerHTML"], GM = { class: "mb-3" }, KM = {
	key: 0,
	for: "password",
	class: "form-label text-primary"
}, qM = { class: "input-group" }, JM = [
	"type",
	"placeholder",
	"pattern",
	"minlength",
	...
	for: "password_again",
	class: "form-label text-primary"
}, eN = ["innerHTML"], tN = { class: "input-group" }, nN = [
	"type",
	"placeholder",
	"minlength",
	"disabled"
...
}, cN = { key: 1 }, lN = ["innerHTML"], uN = { class: "d-flex justify-content-center gap-2 flex-wrap" }, dN = ["onClick"], fN = {
	key: 3,
	class: "text-danger text-center small mt-2 mb-3 fw-semibold"
}, pN = {
	key: 4,
	class: "mb-3"
}, mN = ["innerHTML"], hN = { class: "form-label text-primary" }, gN = { class: "input-group" }, _N = ["placeholder", "disabled"], vN = { class: "text-end mt-2" }, yN = ["disabled"], bN = {
	key: 5,
	class: "mb-4 text-center"
}, xN = ["innerHTML"], SN = {
	key: 6,
	class: "d-flex mb-4"
}, CN = ["innerHTML"], wN = { class: "row" }, TN = { class: "mb-3" }, EN = ["for", "innerHTML"], DN = { class: "input-group" }, ON = ["innerHTML"], kN = [
	"disabled",
	"required",
	"onUpdate:modelValue",
	"multiple"
], AN = ["value", "innerHTML"], jN = [
	"id",
	"name",
	"type",
	"onUpdate:modelValue",
...
}, BN = ["innerHTML"], VN = { class: "mt-4 d-flex justify-content-between" }, HN = ["disabled"], UN = ["disabled"], WN = ["disabled"], GN = {
	key: 0,
	class: "bi bi-person-plus mx-1"
}, KN = {
	key: 1,
	class: "bi bi-arrow-right-square mx-1"
}, qN = { class: "mt-2 text-end" }, JN = ["disabled"], YN = ["id"], XN = { class: "modal-dialog modal-xl" }, ZN = { class: "modal-content h-100" };
function QN(o, s, c, l, u, d) {
	let f = y("VuAdminForm");
	return o.auth && o.auth.visible ? (g(), r("div", {
		...
		i("div", LM, [o.loading ? (g(), r("i", RM)) : n("", !0), i("button", {
			type: "button",
			class: "btn p-2",
			onClick: s[0] ||= O((...e) => o.close && o.close(...e), ["stop"])
		}, [...s[18] ||= [i("i", { class: "bi bi-x px-1 text-muted" }, null, -1)]])]),
		i("h1", zM, b(o.settings.title[o.auth.panel]), 1),
		i("form", {
			onSubmit: s[13] ||= O((e) => o.handleSubmit(), ["prevent"]),
			onClick: s[14] ||= O(() => {}, ["stop"])
		}, [
			o.auth.panel != "activation" && o.auth.panel != "password" && o.auth.panel != "twofa" ? (g(), r("div", BM, [
				i("label", VM, b(o.settings.username.label), 1),
				i("div", HM, [o.settings.username.icon ? (g(), r("span", {
					key: 0,
			...
			o.auth.panel != "forgot" && o.auth.panel != "activation" && o.auth.panel != "twofa" ? (g(), r(e, { key: 1 }, [i("div", GM, [
				o.settings.password.label ? (g(), r("label", KM, b(o.settings.password.label), 1)) : n("", !0),
				i("div", qM, [
					...
					}, [o.settings.password.type == "password" ? (g(), r("i", YM)) : (g(), r("i", XM))], 2)
				]),
			...
			]), o.auth.panel === "registration" || o.auth.panel === "password" ? (g(), r("div", QM, [
				i("label", $M, [a(b(o.settings.password_again.label) + " ", 1), o.password_again.length > 0 && o.password_again != o.password ? (g(), r("small", {
					key: 0,
					class: "text-danger",
				...
				i("div", tN, [
					...
					}, [o.settings.password_again.type == "password" ? (g(), r("i", rN)) : (g(), r("i", iN))], 2)
				]),
			...
			o.captchaRequired ? (g(), r("div", oN, [o.captcha.loading ? (g(), r("div", sN, [...s[19] ||= [i("span", { class: "spinner-border spinner-border-sm text-secondary" }, null, -1)]])) : o.captcha.items.length ? (g(), r("div", cN, [i("div", {
				class: "text-center small mb-2",
				innerHTML: o.captcha.question
			}, null, 8, lN), i("div", uN, [(g(!0), r(e, null, v(o.captcha.items, (e) => (g(), r("button", {
				key: e.id,
				type: "button",
			...
			}, null, 2)], 10, dN))), 128))])])) : n("", !0)])) : n("", !0),
			o.captchaError ? (g(), r("p", fN, b(o.settings.captcha.error), 1)) : n("", !0),
			o.auth.panel === "twofa" && o.settings.twofa ? (g(), r("div", pN, [
				i("p", {
					class: "text-center small text-muted mb-3",
					innerHTML: o.settings.twofa.info
				}, null, 8, mN),
				i("label", hN, b(o.settings.twofa.label), 1),
				i("div", gN, [s[20] ||= i("span", { class: "input-group-text" }, [i("i", { class: "bi bi-shield-lock" })], -1), D(i("input", {
					type: "text",
					inputmode: "numeric",
					pattern: "[0-9]{6}",
					maxlength: "6",
				...
				}, null, 8, _N), [[T, o.twofaCode]])]),
				i("div", vN, [i("button", {
					type: "button",
					class: "btn btn-link btn-sm p-0 text-decoration-none",
					onClick: s[7] ||= O((...e) => o.resendTwofa && o.resendTwofa(...e), ["stop"]),
					disabled: o.loading
				}, [s[21] ||= i("i", { class: "bi bi-arrow-repeat me-1" }, null, -1), a(b(o.settings.submit.resend), 1)], 8, yN)])
			])) : n("", !0),
			D(i("input", {
				type: "text",
				name: "vu_b4t",
			...
			o.auth.panel == "login" && o.settings.password.forgot ? (g(), r("div", bN, [i("button", {
				type: "button",
			...
			o.auth.panel == "forgot" && o.settings.help && o.settings.help.forgot ? (g(), r("div", SN, [i("small", {
				class: "text-muted",
				innerHTML: o.settings.help.forgot
			}, null, 8, CN)])) : n("", !0),
			i("div", wN, [(g(!0), r(e, null, v(o.settings.inputs, (t, a) => (g(), r(e, { key: a }, [t.panels.indexOf(o.auth.panel) >= 0 && !t.hidden ? (g(), r("div", {
				key: 0,
				...
				i("div", DN, [
					...
					}, null, 8, AN))), 128))], 8, kN)), [[w, o.inputs[a]]]) : D((g(), r("input", {
						key: 2,
						id: a,
						name: a,
						type: t.type,
			...
			(g(!0), r(e, null, v(o.settings.accepts, (e) => (g(), r("div", { key: e }, [e.panels.indexOf(o.auth.panel) >= 0 ? (g(), r("div", PN, [D(i("input", {
				type: "checkbox",
				...
				required: e.required,
				disabled: o.loading
			}, null, 8, FN), [[S, o.accepts[e.name]]]), e.label ? (g(), r("label", {
				key: 0,
				class: "form-check-label",
				for: "accept_" + e.name,
				innerHTML: o.getValueOrFunction(e.label)
			}, null, 8, IN)) : n("", !0)])) : n("", !0)]))), 128)),
			o.auth.panel == "registration" && o.settings.help && o.settings.help.registration ? (g(), r("div", LN, [i("div", { innerHTML: o.getValueOrFunction(o.settings.help.registration) }, null, 8, RN)])) : n("", !0),
			o.auth.response.message ? (g(), r("div", zN, [i("div", {
				class: p({
			...
			i("div", VN, [
				o.auth.panel != "login" && o.auth.panel != "activation" ? (g(), r("button", {
					...
					disabled: o.loading
				}, [s[23] ||= i("i", { class: "bi bi-arrow-left-square mx-1" }, null, -1), a(" " + b(o.settings.submit.login), 1)], 8, HN)) : n("", !0),
				o.auth.panel == "login" ? (g(), r("button", {
					...
					disabled: o.loading
				}, [s[24] ||= i("i", { class: "bi bi-person-plus mx-1" }, null, -1), a(" " + b(o.settings.submit.registration), 1)], 8, UN)) : n("", !0),
				i("button", {
					type: "submit",
					...
					disabled: o.loading
				}, [a(b(o.settings.submit[o.auth.panel]) + " ", 1), o.auth.panel == "registration" ? (g(), r("i", GN)) : (g(), r("i", KN))], 10, WN)
			]),
			i("div", qN, [i("button", {
				type: "button",
				...
				disabled: o.loading
			}, [a(b(o.settings.submit.cancel) + " ", 1), s[25] ||= i("i", { class: "bi bi-x-square mx-1" }, null, -1)], 8, JN)])
		], 32)
	])])]), i("div", {
		class: "modal shadow",
		id: o.modalId,
		tabindex: "-1"
	}, [i("div", XN, [i("div", ZN, [o.settings.form && o.settings.form.visible && o.settings.form.groups ? (g(), t(f, {
		key: 0,
		modelValue: o.item,
...
var $N = /* @__PURE__ */ NT(PM, [["render", QN]]);
//#endregion
...
function uP(t, a, o, s, c, l) {
	...
	}, null, 2)) : n("", !0), i("span", { innerHTML: t.getValueOrFunction(t.settings.label) }, null, 8, lP)], 2)]))], 8, tP)) : n("", !0);
}
var dP = /* @__PURE__ */ NT(eP, [["render", uP]]);
//#endregion
export { MM as VuAdmin, $N as VuAuth, dP as VuUserButton };
